var ZKUploader = function() {
    function __internalInit(e) {
        return e = e || {}, e['demoMessage'] = 'This is a demo version of ZKUploader', e['hello'] = 'Hello fellow cracker!', e['isDemo'] = !0, e
    }

    function internalZKUploaderInit(e, t, n) {
        var i = t.getElementsByTagName('head')[0],
            r = t.createElement('script');
        r[r.innerText ? 'innerText' : 'innerHTML'] = n + '.ZKUploader._setup( window, document );ZKUploader.start(' + JSON.stringify(e) + ');', i.appendChild(r)
    }
    ...
    function checkOnInit(e, t) {
        ...
        if ((n.indexOf('MSIE ') > 0 || n.indexOf('Trident/') > 0 || n.indexOf('Edge/') > 0) && t.addEventListener('ZKUploaderReady', function(e) {
                setTimeout(function() {
                    var t = e.detail.ZKUploader,
                        n = getCookie('ckCsrfToken');
                    n || (n = t.request('csrf:getToken'), setCookie('ckCsrfToken', n)), t.request('internal:csrf:setParentWindowToken', {
                        token: n
                    })
                }, 1e3)
            }), e && !e._omitCheckOnInit && "function" == typeof e.onInit) {
            var i = e.onInit;
            delete e.onInit, t.addEventListener('ZKUploaderReady', function(t) {
                e._initCalled || (e._initCalled = !0, i(t.detail.ZKUploader))
            })
        }
    }
    ...
    var connectors = {
            ...
            net: '/ZKUploader/connector'
        },
        connector = 'php',
        basePath = function() {
            if (parent && parent.ZKUploader && parent.ZKUploader.basePath) return parent.ZKUploader.basePath;
            var e, t, n, i = document.getElementsByTagName('script');
            for (e = 0; e < i.length && (t = i[e], n = void 0 !== t.getAttribute.length ? t.src : t.getAttribute('src'), !n || n.split("/").slice(-1)[0] !== 'zkuploader.js'); e++);
        ...
        Modal = {
            open: function(e) {
                ...
                function r(e) {
                    ...
                    p = t.x, m = t.y;
                    var n = m - B;
                    w.style.left = p - b + 'px', w.style.top = (0 > n ? 0 : n) + 'px'
                }

                function o(e) {
                    var t, n, r = i(e);
                    f ? (t = l - (I - r.x), n = u - (T - r.y), t > 200 && (F.style.width = t + 'px'), n > 200 && (F.style.height = n + 'px')) : h && (t = l + (I - r.x), n = u - (T - r.y), t > 200 && (F.style.width = t + 'px', w.style.left = b - (I - r.x) + 'px'), n > 200 && (F.style.height = n + 'px'))
                }

                function s() {
                    M.parentNode === F && F.removeChild(M), f = !1, h = !1, n(document, ['mousemove', 'touchmove'], o), n(document, ['mouseup', 'touchend'], s)
                }

                function a(e) {
                    e.preventDefault();
                    var n = i(e);
                    I = n.x, T = n.y, l = F.clientWidth, u = F.clientHeight, F.appendChild(M), t(document, ['mousemove', 'touchmove'], o), t(document, ['mouseup', 'touchend'], s)
                }
                if (e = e || {}, !Modal.div) {
                    ...
                    w.id = 'ckf-modal', w.style.position = 'fixed', w.style.top = (document.documentElement.clientHeight - Modal.heightAdded) / 2 - d / 2 + 'px', w.style.left = (document.documentElement.clientWidth - Modal.widthAdded) / 2 - c / 2 + 'px', w.style.background = '#fff', w.style.border = '1px solid #aaa', w.style.boxShadow = '3px 3px 5px rgba(0,0,0,0.2)', w.style.borderTopLeftRadius = w.style.borderTopRightRadius = '5px', w.style.zIndex = 8999, w.innerHTML = '<div id="ckf-modal-header" style="cursor: move; border-top-left-radius:5px; border-top-right-radius:5px; background: url(data:image/svg+xml;base64,);border-bottom:1px solid #c9c9c9;height:35px !important;">' + '<a style="float: right; padding: 7px 10px 0 !important; margin: 0 !important; font-family: Arial, sans-serif !important; font-weight:bold; font-size: 20px !important; line-height: 20px !important; text-decoration: none !important; color: #888 !important;" id="ckf-modal-close" href="#">×</a>' + '</div>' + '<div id="ckf-modal-body" style="position: relative;width: ' + c + 'px; height: ' + d + 'px"></div>' + '<div id="ckf-modal-footer" style="height: 10px !important; background: #f3f3f3">' + '<span id="ckf-modal-resize-handle-sw" style="cursor: sw-resize; width: 7px; height: 7px; display: block; float: left; border-left: 3px solid #ddd; border-bottom: 3px solid #ddd;"></span>' + '<span id="ckf-modal-resize-handle-se" style="cursor: se-resize; width: 7px; height: 7px; display: block; float: right; border-right: 3px solid #ddd; border-bottom: 3px solid #ddd;"></span>' + '</div>', document.body.appendChild(w), ZKUploader.widget('ckf-modal-body', e), Modal.footer = document.getElementById('ckf-modal-footer'), window.addEventListener('orientationchange', function() {
                        Modal.maximized || setTimeout(function() {
                            ...
                            e.style.width = c + 'px', e.style.height = d + 'px', w.style.top = (document.documentElement.clientHeight - Modal.heightAdded) / 2 - d / 2 + 'px', w.style.left = (document.documentElement.clientWidth - Modal.widthAdded) / 2 - c / 2 + 'px'
                        }, 100)
                    });
                    ...
                    t(C, ['mousedown', 'touchstart'], function(e) {
                        ...
                        var n = i(e);
                        p = n.x, m = n.y, b = p - w.offsetLeft, B = m - w.offsetTop, F.appendChild(M), t(document, ['mousemove', 'touchmove'], r)
                    }), t(C, ['mouseup', 'touchend'], function() {
                        g = !1, M.parentNode === F && F.removeChild(M), n(document, ['mousemove', 'touchmove'], r)
                    });
                    var E = document.getElementById('ckf-modal-resize-handle-se'),
                        _ = document.getElementById('ckf-modal-resize-handle-sw'),
                        F = Modal.body = document.getElementById('ckf-modal-body'),
                        M = document.createElement('div');
                    M.style.position = 'absolute', M.style.top = M.style.right = M.style.bottom = M.style.left = 0, M.style.zIndex = 1e5, t(E, ['mousedown', 'touchstart'], function(e) {
                        f = !0, a(e)
                    }), t(_, ['mousedown', 'touchstart'], function(e) {
    ...
    return {
        ...
        config: function(e) {
            ZKUploader._config = e
        },
        widget: function(e, t) {
            function n(e) {
                return e + (/^[0-9]+$/.test(e) ? 'px' : "")
            }
            if (t = t || {}, !e) throw 'No "id" option defined in ZKUploader.widget() call.';
            var i = 'border:none;';
            ...
            r.src = "", r.setAttribute('style', i), r.setAttribute('seamless', 'seamless'), r.setAttribute('scrolling', 'auto'), r.setAttribute('tabindex', configOrDefault(t.tabindex, 0)), r.attachEvent ? r.attachEvent('onload', function() {
                internalZKUploaderInit(t, r.contentDocument, 'parent')
            }) : r.onload = function() {
                /iPad|iPhone|iPod/.test(navigator.platform) && (updateIOSConfig(t, r), r.contentWindow.addEventListener('ZKUploaderReady', function(e) {
                    e.detail.ZKUploader.on('ui:resize', function(e) {
                        updateIOSConfig(e.finder.config, r)
                    }, null, null, 1)
                })), internalZKUploaderInit(t, r.contentDocument, 'parent')
            };
            var o = document.getElementById(e);
            if (!o) throw 'ZKUploader.widget(): could not find element with id "' + e + '".';
            o.innerHTML = "", o.appendChild(r), checkOnInit(t, r.contentWindow)
        },
        popup: function(e) {
            function t() {
                ckfPopupWindow && (r = ckfPopupWindow.document, r.open(), r.write('<!DOCTYPE html>' + '<html>' + '<head>' + '<meta charset="utf-8">' + '<meta name="viewport" content="width=device-width,initial-scale=1,user-scalable=no">' + '<title>ZKUploader 3 - File Browser</title>' + '</head>' + '<body>' + '<script src="' + window.ZKUploader.basePath + 'zkuploader.js" charset="utf-8"></script>' + '<script>' + 'window.isZKUploaderPopup=true;' + 'window.onload=function() {' + '    ZKUploader.start( window.opener.ZKUploader._popupOptions );' + "}" + '</script>' + '</body>' + '</html>'), r.close(), ckfPopupWindow.focus())
            }
            e = e || {}, window.ZKUploader._popupOptions = e;
            var n = isIE9() ? window.ZKUploader.basePath + 'index.html' : 'about:blank',
        ...
        start: function(e) {
            if (!e) {
                ...
                if (n.popup && (window.isZKUploaderPopup = !0), t && n.configId && t.ZKUploader && t.ZKUploader._popupOptions) {
                    var a = decodeURIComponent(n.configId);
                    e = t.ZKUploader._popupOptions[a] || {}, e._omitCheckOnInit = !0
                }
            }
            ZKUploader._setup(window, document), checkOnInit(e, window), ZKUploader.start(e)
        },
        setupCKEditor: function(e, t, n) {
            ...
            if (!e) {
                for (var r in CKEDITOR.instances) ZKUploader.setupCKEditor(CKEDITOR.instances[r]);
                return void CKEDITOR.on('instanceCreated', function(e) {
                    ZKUploader.setupCKEditor(e.editor)
                })
            }
            e.config.filebrowserBrowseUrl = window.ZKUploader.basePath + 'index.html', n = extendObject({
                command: 'QuickUpload',
                type: 'Files'
            }, n), t = extendObject(window.ZKUploader._config || {}, t);
            var o = window.ZKUploader._connectors[window.ZKUploader.connector];
            "/" !== o.charAt(0) && (o = window.ZKUploader.basePath + o), o = i(o), Object.keys(t).length && (window.ZKUploader._popupOptions || (window.ZKUploader._popupOptions = {}), t._omitCheckOnInit = !0, window.ZKUploader._popupOptions[e.name] = t, e.config.filebrowserBrowseUrl += '?popup=1&configId=' + encodeURIComponent(e.name), t.connectorPath && (o = i(t.connectorPath))), e.config.filebrowserUploadUrl = o + createUrlParams(n)
        },
        _setup: function(window, document) {
            window.ZKUploader = window.ZKUploader || {}, window.ZKUploader.connector = connector, window.ZKUploader._connectors = connectors, window.ZKUploader.basePath = function() {
                if (window.parent && window.parent.ZKUploader && window.parent.ZKUploader.basePath) return window.parent.ZKUploader.basePath;
                for (var e, t, n = document.getElementsByTagName('script'), i = 0; i < n.length && (e = n[i], t = void 0 !== e.getAttribute.length ? e.src : e.getAttribute('src'), !t || t.split("/").slice(-1)[0] !== 'zkuploader.js'); i++);
                return t.split("/").slice(0, -1).join("/") + "/"
            }();
            var ZKUploader;
            ! function() {
                if (!ZKUploader || !ZKUploader.requirejs) {
                    ZKUploader ? require = ZKUploader : ZKUploader = {};
                    ...
                    ! function(global) {
                        ...
                        function newContext(e) {
                            ...
                            function s(e, t, i, r) {
                                ...
                                return e || (h = !1, e = "_@r" + (P += 1)), u = o(e), c = u[0], e = u[1], c && (c = n(c, d, r), a = getOwn(I, c)), e && (c ? g = a && a.normalize ? a.normalize(e, function(e) {
                                    return n(e, d, r)
                                }) : -1 === e.indexOf("!") ? n(e, d, r) : e : (g = n(e, d, r), u = o(g), c = u[0], g = u[1], i = !0, s = y.nameToUrl(g))), l = !c || a || i ? "" : '_unnormalized' + (O += 1), {
                                    prefix: c,
                                    name: g,
                                    parentMap: t,
                                    unnormalized: !!l,
                            ...
                            function h() {
                                ...
                                if (!x) {
                                    if (x = !0, eachProp(_, function(e) {
                                        ...
                                        }), o && s.length) return e = makeError('timeout', 'Load timeout for modules: ' + s, null, s), e.contextName = y.contextName, u(e);
                                    c && each(a, function(e) {
                                        f(e, {}, {})
                            ...
                            return C = {
                                                ...
                                                if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                                    if (isFunction(o)) {
                                                        ...
                                                        if (this.map.isDefine && void 0 === r && (t = this.module, t ? r = t.exports : this.usingExports && (r = this.exports)), e) {
                                                            if (this.events.error && this.map.isDefine || req.onError !== defaultOnError) return e.requireMap = this.map, e.requireModules = this.map.isDefine ? [this.map.id] : null, e.requireType = this.map.isDefine ? "define" : "require", u(this.error = e);
                                ...
                                callPlugin: function() {
                                    ...
                                    this.depMaps.push(i), l(i, "defined", bind(this, function(i) {
                                        ...
                                        })), c = getOwn(E, o.id), void(c && (this.depMaps.push(o), this.events.error && c.on('error', bind(this, function(e) {
                                            this.emit('error', e)
                                ...
                                configure: function(e) {
                                    ...
                                    eachProp(e, function(e, t) {
                                        ...
                                        e = "string" == typeof e ? {
                                            name: e
                                        } : e, n = e.name, t = e.location, t && (B.paths[n] = e.location), B.pkgs[n] = e.name + "/" + (e.main || 'main').replace(currDirRegExp, "").replace(jsSuffixRegExp, "")
                                    }), eachProp(E, function(e, t) {
                                ...
                                makeRequire: function(t, r) {
                                    function o(n, i, l) {
                                        var c, d, f;
                                        return r.enableBuildCallback && i && isFunction(i) && (i.__requireJsBuild = !0), "string" == typeof n ? isFunction(i) ? u(makeError('requireargs', 'Invalid require call'), l) : t && hasProp(C, n) ? C[n](E[t.id]) : req.get ? req.get(y, n, t, o) : (d = s(n, t, !1, !0), c = d.id, hasProp(I, c) ? I[c] : u(makeError('notloaded', 'Module name "' + c + '" has not been loaded yet for context: ' + e + (t ? "" : '. Use require([])')))) : (v(), y.nextTick(function() {
                                ...
                                completeLoad: function(e) {
                                    ...
                                    if (y.defQueueMap = {}, i = getOwn(E, e), !t && !hasProp(I, e) && i && !i.inited) {
                                        if (!(!B.enforceDefine || s && getGlobal(s))) return r(e) ? void 0 : u(makeError('nodefine', 'No define call for ' + e, null, [e]));
                        ...
                        if ("undefined" == typeof define) {
                            ...
                            "undefined" == typeof require || isFunction(require) || (cfg = require, require = void 0), req = requirejs = function(e, t, n, i) {
                                ...
                                return head || (head = e.parentNode), dataMain = e.getAttribute('data-main'), dataMain ? (mainScript = dataMain, cfg.baseUrl || (src = mainScript.split("/"), mainScript = src.pop(), subPath = src.length ? src.join("/") + "/" : './', cfg.baseUrl = subPath), mainScript = mainScript.replace(jsSuffixRegExp, ""), req.jsExtRegExp.test(mainScript) && (mainScript = dataMain),
                    ...
                    }(this), ZKUploader.requirejs = requirejs, ZKUploader.require = require, ZKUploader.define = define
                }
            }(), ZKUploader.define('requireLib', function() {}),
                function() {
                    function e(e, t, n) {
                    ...
                    function f(n) {
                        ...
                        function Z(e, t, n, i, r) {
                            ...
                            return f && (Dn.call(e, 'index') && (o.index = e.index), Dn.call(e, 'input') && (o.input = e.input)), t ? (i.push(e), r.push(o), (f ? Qe : ui)(e, function(e, s) {
                                o[s] = Z(e, t, n, i, r)
                            }), h && (u(i), u(r)), o) : o
                        }
                        ...
                        function ne(e, t, n, i, r, o) {
                            ...
                            var h = d == V;
                            if (!h) {
                                var g = Dn.call(e, '__wrapped__'),
                                    p = Dn.call(t, '__wrapped__');
                                if (g || p) return ne(g ? e.__wrapped__ : e, p ? t.__wrapped__ : t, n, i, r, o);
                                if (d != q) return !1;
                                var m = e.constructor,
                                    v = t.constructor;
                                if (m != v && !(Te(m) && m instanceof m && Te(v) && v instanceof v) && 'constructor' in e && 'constructor' in t) return !1
                            }
                            var x = !r;
                            r || (r = a()), o || (o = a());
                        ...
                        function Nt(e, t, n) {
                            ...
                            if (t = zn(0, t) || 0, n === !0) {
                                var g = !0;
                                f = !1
                            } else Re(n) && (g = n.leading, d = 'maxWait' in n && (zn(t, n.maxWait) || 0), f = 'trailing' in n ? n.trailing : f);
                            var p = function() {
                                    var n = t - (pi() - s);
                                    if (0 >= n) {
                                        r && Rn(r);
                        ...
                        function Xt(e, t, n) {
                            var i = !0,
                                r = !0;
                            if (!Te(e)) throw new Bn;
                            return n === !1 ? i = !1 : Re(n) && (i = 'leading' in n ? n.leading : i, r = 'trailing' in n ? n.trailing : r), $.leading = i, $.maxWait = t, $.trailing = r, Nt(e, t, $)
                        }
                        ...
                        function jt(e, t, n) {
                            var i = !0,
                                r = t && ye(t);
                            t && (n || r.length) || (null == n && (n = t), o = p, t = e, e = g, r = ye(t)), n === !1 ? i = !1 : Re(n) && 'chain' in n && (i = n.chain);
                            var o = e,
                                s = Te(o);
                            Qe(r, function(n) {
                                var r = e[n] = t[n];
                        ...
                        function sn(e, t, n) {
                            ...
                            var p = n.variable,
                                m = p;
                            m || (p = 'obj', d = 'with (' + p + ') {' + d + '}'), d = (r ? d.replace(C, "") : d).replace(b, '$1').replace(B, '$1;'), d = 'function(' + p + ') {' + (m ? "" : p + ' || (' + p + ' = {});') + "var __t, __p = '', __e = _.escape" + (r ? ', __j = Array.prototype.join;' + "function print() { __p += __j.call(arguments, '') }" : ';') + d + 'return __p}';
                            var v = '/*//# sourceURL=' + (n.sourceURL || '/lodash/template/source[' + A++ + "]") + '*/';
                            try {
                                var x = vn(a, 'return ' + d + v).apply(h, l)
                            } catch (w) {
                                throw w.source = d, w
                            }
                        ...
                        var gn = n.Array,
                            ...
                            Fn = n._,
                            Mn = _n.toString,
                            In = Cn("^" + bn(Mn).replace(/[.*+?^${}()|[\]\\]/g, '\$&').replace(/toString| for [^\]]+/g, '.*?') + "$"),
                            Tn = xn.ceil,
                            Rn = n.clearTimeout,
                            Pn = xn.floor,
                        ...
                        var Gn = Nn ? function(e, t) {
                                z.value = t, Nn(e, '__bindData__', z), z.value = null
                            } : tn,
                            jn = Wn || function(e) {
                        ...
                        }), g.VERSION = '2.4.2', g.prototype.chain = fn, g.prototype.toString = Sn, g.prototype.value = hn, g.prototype.valueOf = hn, Qe(['join', 'pop', 'shift'], function(e) {
                            var t = En[e];
                        ...
                        }), Qe(['push', 'reverse', 'sort', 'unshift'], function(e) {
                            var t = En[e];
                            g.prototype[e] = function() {
                                return t.apply(this.__wrapped__, arguments), this
                            }
                        }), Qe(['concat', 'slice', 'splice'], function(e) {
                            var t = En[e];
                            g.prototype[e] = function() {
                    ...
                    var h, g = [],
                        ...
                        R = /\bthis\b/,
                        P = /['\n\r\t\u2028\u2029\\]/g,
                        O = ['Array', 'Boolean', 'Date', 'Function', 'Math', 'Number', 'Object', 'RegExp', 'String', "_", 'attachEvent', 'clearTimeout', 'isFinite', 'isNaN', 'parseInt', 'setTimeout'],
                        A = 0,
                        D = '[object Arguments]',
                        V = "[object Array]",
                        K = '[object Boolean]',
                    ...
                    var ee = f();
                    "function" == typeof ZKUploader.define && "object" == typeof ZKUploader.define.amd && ZKUploader.define.amd ? (J._ = ee, ZKUploader.define('underscore', [], function() {
                        return ee
                ...
                function() {
                    ...
                    }(), "undefined" != typeof module && module.exports ? module.exports = i : "function" == typeof ZKUploader.define && ZKUploader.define.amd ? ZKUploader.define('doT', [], function() {
                        return i
                    }) : n.doT = i;
                    var r = {
                            start: "'+(",
                ...
                function(e, t) {
                    if ("function" == typeof ZKUploader.define && ZKUploader.define.amd) ZKUploader.define('backbone', ['underscore', 'jquery', 'exports'], function(n, i, r) {
                    ...
                    n.extend(f.prototype, a, {
                        ...
                        save: function(e, t, i) {
                            ...
                            }, L(this, i), o = this.isNew() ? "create" : i.patch ? "patch" : "update", o === 'patch' && (i.attrs = r), s = this.sync(o, this, i), r && i.wait && (this.attributes = a), s
                        },
                        destroy: function(e) {
                            e = e ? n.clone(e) : {};
                            var t = this,
                    ...
                    n.extend(g.prototype, a, {
                        ...
                        set: function(e, t) {
                            ...
                            for (r = 0, o = e.length; o > r; r++) {
                                if (l = e[r] || {}, s = l instanceof f ? a = l : l[h.prototype.idAttribute || 'id'], u = this.get(s)) b && (w[u.cid] = !0), C && (l = l === a ? a.attributes : l, t.parse && (l = u.parse(l, t)), u.set(l, t), g && !c && u.hasChanged(m) && (c = !0)), e[r] = u;
                                else if (y) {
                            ...
                            if (c && this.sort({
                                ...
                                (c || B && B.length) && this.trigger('sort', this, t)
                            }
                            return i ? e[0] : e
                        },
                        reset: function(e, t) {
                    ...
                    var w = t.View = function(e) {
                            this.cid = n.uniqueId('view'), e || (e = {}), n.extend(this, n.pick(e, C)), this._ensureElement(), this.initialize.apply(this, arguments), this.delegateEvents()
                        },
                        y = /^(\S+)\s*(.*)$/,
                    ...
                    n.extend(E.prototype, a, {
                        ...
                        _routeToRegExp: function(e) {
                            return e = e.replace(I, '\$&').replace(_, '(?:$1)?').replace(F, function(e, t) {
                                return t ? e : '([^/?]+)'
                            }).replace(M, '([^?]*?)'), new RegExp("^" + e + '(?:\?([\s\S]*))?$')
                        },
                    ...
                    return t
                }), ZKUploader.define('ZKUploader/Config', [], function() {
                    "use strict";
                    var e = {
                        id: "",
                        ...
                        iconsCSS: "",
                        themeCSS: "",
                        coreCSS: 'skins/core/zkuploader.css',
                        primaryPanelWidth: "",
                        secondaryPanelWidth: "",
                        cors: !1,
                        corsSelect: !1,
                    ...
                    return e
                }), ZKUploader.define('ZKUploader/Event', [], function() {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Util/Util', ['underscore'], function(e) {
                    "use strict";
                    var t = {
                        url: function(e) {
                            return /^(http(s)?:)?\/\/.+/i.test(e) ? e : ZKUploader.require.toUrl(e)
                        },
                        ...
                        isPopup: function() {
                            return window !== window.parent && !!window.opener || window.isZKUploaderPopup
                        },
                        isModal: function() {
                            return window.parent.ZKUploader && window.parent.ZKUploader.modal && window.parent.ZKUploader.modal('visible')
                        },
                        isWidget: function() {
                        ...
                        isShortcut: function(t, n) {
                            var i = n.split("+"),
                                ...
                                l = o === (e.contains(i, 'alt') ? !0 : !1),
                                u = s === (e.contains(i, 'shift') ? !0 : !1);
                            return a && l && u
                        },
                    ...
                    return t
                }), ZKUploader.define('ZKUploader/Util/Lang', ['underscore', 'jquery', 'ckf_global'], function(e, t, n) {
                    "use strict";
                    ...
                    function i(e, t, i, o) {
                        ...
                        var l, u = 'lang/' + t + '.json';
                        i[e] && (l = 'lang/' + e + '.json'), l || (l = u), n.require(['text!' + n.require.toUrl(l) + '?ver=0pd3pz'], s, a)
                    }
                    var r = {
                    ...
                    return r
                }), ZKUploader.define('ZKUploader/Util/KeyCode', {
                    up: 38,
                    down: 40,
                    left: 37,
                    right: 39,
                    ...
                    f9: 120,
                    f10: 121
                }), ZKUploader.define('ZKUploader/UI/UIHacks', ['underscore', 'jquery', 'ZKUploader/Util/KeyCode', 'ckf-jquery-mobile'], function(e, t, n) {
                    "use strict";
                    ...
                    return {
                        init: function(e) {
                            ...
                            t.event.special.swipe.start = function(e) {
                                ...
                                e.util.isPopup() ? window.close() : window.top && window.top.ZKUploader && window.top.ZKUploader.modal && window.top.ZKUploader.modal('close')
                ...
                }), ZKUploader.define('ZKUploader/Plugins/Plugin', ['underscore', 'jquery', 'backbone'], function(e, t, n) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Plugins/Plugins', ['underscore', 'jquery', 'backbone', 'ZKUploader/Plugins/Plugin', 'ZKUploader/Util/Lang'], function(e, t, n, i, r) {
                    "use strict";
                    ...
                    var s = n.Collection.extend({
                        load: function(t) {
                            ...
                            return s.length < 1 ? void t.fire('plugin:allReady', null, t) : (e.isString(s) && (s = s.split(",")), e.forEach(s, function(e) {
                                var t = e; - 1 === e.search("/") && (t = ZKUploader.require.toUrl('plugins/' + e + "/" + e + ".js")), r.push({
                                    config: e,
                                    url: t,
                                    loaded: void 0
                                })
                                ...
                                ZKUploader.require([e.url], function(n) {
                                    var r = i.extend(n);
                                    o(t, new r, e)
                                }, function() {
                                    e.loaded = !1, n()
                    ...
                    return s
                }), ZKUploader.define('ZKUploader/Modules/CsrfTokenManager/CsrfTokenManager', [], function() {
                    "use strict";
                    ...
                    var o = 'ckCsrfToken',
                        ...
                        a = null;
                    return e
                }), ZKUploader.define('ZKUploader/Modules/Connector/Transport', ['jquery', 'underscore'], function(e, t) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Modules/Connector/Connector', ['underscore', 'jquery', 'ckf_global', 'ZKUploader/Modules/Connector/Transport'], function(e, t, n, i) {
                    "use strict";
                ...
                function(e, t) {
                    if ("function" == typeof ZKUploader.define && ZKUploader.define.amd) ZKUploader.define('marionette', ['backbone', 'underscore'], function(n, i) {
                        ...
                        show: function(e, t) {
                            if (this._ensureElement()) {
                                ...
                                var i = t || {},
                                    ...
                                    u = r && !s,
                                    c = r || a;
                                if (l && this.triggerMethod('before:swapOut', this.currentView, this, t), this.currentView && delete this.currentView._parent, u ? this.empty() : l && c && this.currentView.off('destroy', this.empty, this), c) {
                ...
                }), ZKUploader.define('ZKUploader/Views/Base/Common', ['underscore', 'marionette'], function(e, t) {
                    "use strict";
                    var n = {
                        proto: {
                            getTemplate: function() {
                                var e = t.getOption(this, 'template'),
                                    n = t.getOption(this, 'imports'),
                                    i = this.name;
                    ...
                    return n
                }), ZKUploader.define('ZKUploader/Views/Base/CompositeView', ['underscore', 'marionette', 'ZKUploader/Views/Base/Common'], function(e, t, n) {
                    "use strict";
                    ...
                    return o
                }), ZKUploader.define('ZKUploader/Views/Base/ItemView', ['marionette', 'ZKUploader/Views/Base/Common'], function(e, t) {
                    "use strict";
                    var n = e.ItemView,
                        i = n.extend(t.proto),
                        r = i.extend({
                    ...
                    return r
                }), ZKUploader.define('text', ['module'], function(e) {
                    "use strict";
                    ...
                    return t = {
                        ...
                        load: function(e, n, i, r) {
                            ...
                            var o = t.parseName(e),
                                ...
                                a = n.toUrl(s),
                                l = g.useXhr || t.useXhr;
                            return 0 === a.indexOf('empty:') ? void i() : void(!u || l(a, c, d, f) ? t.get(a, function(n) {
                        ...
                        try {
                            n = i['@mozilla.org/network/file-input-stream;1'].createInstance(r.nsIFileInputStream), n.init(a, 1, 0, !1), s = i['@mozilla.org/intl/converter-input-stream;1'].createInstance(r.nsIConverterInputStream), s.init(n, 'utf-8', n.available(), r.nsIConverterInputStream.DEFAULT_REPLACEMENT_CHARACTER), s.readString(n.available(), l), s.close(), n.close(), t(l.value)
                        } catch (u) {
                            throw new Error((a && a.path || "") + ': ' + u)
                        }
                    }), t
                }), ZKUploader.define('text!ZKUploader/Templates/ContextMenu/ContextMenuItem.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/ContextMenu/Views/ContextMenuView', ['underscore', 'jquery', 'ZKUploader/Views/Base/CompositeView', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/ContextMenu/ContextMenuItem.dot', 'ZKUploader/Util/KeyCode'], function(e, t, n, i, r, o) {
                    "use strict";
                    ...
                    return a
                }), ZKUploader.define('ZKUploader/Modules/ContextMenu/ContextMenu', ['underscore', 'backbone', 'ZKUploader/Modules/ContextMenu/Views/ContextMenuView'], function(e, t, n) {
                    "use strict";
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Models/FoldersCollection', ['backbone', 'ZKUploader/Models/Folder'], function(e, t) {
                    "use strict";
                    ...
                    return n
                }), ZKUploader.define('ZKUploader/Models/Folder', ['backbone', 'ZKUploader/Models/FoldersCollection'], function(e, t) {
                    "use strict";
                    ...
                    return n
                }), ZKUploader.define('text!ZKUploader/Templates/Folders/FolderNameDialogTemplate.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Folders/Views/FolderNameDialogView', ['ZKUploader/Views/Base/ItemView', 'ZKUploader/Models/Folder', 'text!ZKUploader/Templates/Folders/FolderNameDialogTemplate.dot'], function(e, t, n) {
                    "use strict";
                    return e.extend({
                ...
                }), ZKUploader.define('ZKUploader/Modules/CreateFolder/CreateFolder', ['backbone', 'ZKUploader/Modules/Folders/Views/FolderNameDialogView'], function(e, t) {
                    "use strict";
                    ...
                    return n
                }), ZKUploader.define('text!ZKUploader/Templates/DeleteFile/DeleteFileError.dot', [], function() {
                    return '{{? it.msg }}<p>{{= it.msg }}</p>{{?}}<ul>{{~ it.errors :error }}<li>{{= error }}</li>{{~}}</ul>'
                }), ZKUploader.define('ZKUploader/Modules/DeleteFile/DeleteFile', ['underscore', 'backbone', 'text!ZKUploader/Templates/DeleteFile/DeleteFileError.dot', 'ZKUploader/Util/KeyCode'], function(e, t, n, i) {
                    "use strict";
                    ...
                    function o(e) {
                        var t, n = this.finder,
                            i = e.files;
                        t = i.length > 1 ? n.lang.files.deleteConfirmation.replace('{count}', i.length) : n.lang.files.fileDeleteConfirmation.replace('{name}', n.util.escapeHtml(i[0].get('name'))), n.request('dialog:confirm', {
                    ...
                    var f = 302;
                    return r
                }), ZKUploader.define('ZKUploader/Modules/DeleteFolder/DeleteFolder', ['ZKUploader/Util/KeyCode'], function(e) {
                    "use strict";
                    ...
                    function t(e) {
                        e.on('dialog:DeleteFolderConfirm:ok', function(t) {
                            ...
                            e.request('dialog:confirm', {
                                ...
                                msg: e.lang.folders.deleteConfirmation.replace('{name}', e.util.escapeHtml(n.get('name')))
                            })
                        }), n(e)
                    }
                    ...
                    return t
                }), ZKUploader.define('ZKUploader/Views/Base/LayoutView', ['marionette', 'ZKUploader/Views/Base/Common'], function(e, t) {
                    "use strict";
                    var n = e.LayoutView,
                        i = n.extend(t.proto),
                        r = i.extend({
                    ...
                    return r
                }), ZKUploader.define('ZKUploader/Views/Base/CollectionView', ['underscore', 'marionette', 'ZKUploader/Views/Base/Common'], function(e, t, n) {
                    "use strict";
                    ...
                    return o
                }), ZKUploader.define('ZKUploader/Modules/Dialogs/Views/DialogButtonView', ['ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/ItemView'], function(e, t) {
                    "use strict";
                    return t.extend({
                        name: 'DialogButton',
                        tagName: 'button',
                ...
                }), ZKUploader.define('ZKUploader/Modules/Dialogs/Views/DialogButtonsView', ['underscore', 'backbone', 'ZKUploader/Views/Base/CollectionView', 'ZKUploader/Modules/Dialogs/Views/DialogButtonView'], function(e, t, n, i) {
                    "use strict";
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Dialogs/DialogLayout.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Dialogs/Views/DialogView', ['underscore', 'jquery', 'ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/LayoutView', 'ZKUploader/Modules/Dialogs/Views/DialogButtonsView', 'text!ZKUploader/Templates/Dialogs/DialogLayout.dot'], function(e, t, n, i, r, o) {
                    "use strict";
                    var s = 20,
                        a = i.extend({
                            template: o,
                    ...
                    return a
                }), ZKUploader.define('ZKUploader/Views/MessageView', ['underscore', 'backbone', 'ZKUploader/Views/Base/ItemView'], function(e, t, n) {
                    "use strict";
                    var i = n.extend({
                        name: 'MessageView',
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Modules/Dialogs/Dialogs', ['underscore', 'jquery', 'backbone', 'ZKUploader/Util/KeyCode', 'ZKUploader/Modules/Dialogs/Views/DialogView', 'ZKUploader/Views/Base/ItemView', 'ZKUploader/Views/MessageView'], function(e, t, n, i, r, o, s) {
                    "use strict";
                    ...
                    return a
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/EditImageLayout.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/EditImageLayout', ['ZKUploader/Views/Base/LayoutView', 'text!ZKUploader/Templates/EditImage/EditImageLayout.dot'], function(e, t) {
                    "use strict";
                    return e.extend({
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/ImagePreview.dot', [], function() {
                    return '<canvas class="ckf-ei-canvas"></canvas>'
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/ImagePreviewView', ['ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/EditImage/ImagePreview.dot'], function(e, t) {
                    "use strict";
                    return e.extend({
                        name: 'ImagePreview',
                        template: t,
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/Action.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/ActionView', ['underscore', 'jquery', 'ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/LayoutView', 'text!ZKUploader/Templates/EditImage/Action.dot'], function(e, t, n, i, r) {
                    "use strict";
                    return i.extend({
                        name: 'ActionView',
                        template: r,
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/ActionsView', ['jquery', 'ZKUploader/Views/Base/CollectionView', 'ZKUploader/Modules/EditImage/Views/ActionView'], function(e, t, n) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Models/EditImageData', ['backbone'], function(e) {
                    "use strict";
                    ...
                    return t
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Tools/Tool', ['backbone'], function(e) {
                    "use strict";
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/Crop.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/CropView', ['ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/EditImage/Crop.dot'], function(e, t, n) {
                    "use strict";
                    return t.extend({
                        name: 'CropView',
                        template: n,
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/CropBox.dot', [], function() {
                    return '<div class="ckf-ei-crop">	<div class="ckf-ei-crop-resize" tabindex="{{= it.tabindex + 1 }}"></div>	<div class="ckf-ei-crop-info"></div></div>'
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/CropBoxView', ['jquery', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/EditImage/CropBox.dot'], function(e, t, n) {
                    "use strict";
                    var i = t.extend({
                        name: 'CropBoxView',
                        ...
                        mouseMove: function(e) {
                            ...
                            t = e.data.model, n = e.data.view.ui.cropBox, i = e.clientX - e.data.moveStart.x, r = e.clientY - e.data.moveStart.y, o = n.outerWidth(),
                                s = n.outerHeight(), a = t.get('maxRenderWidth') - o, l = t.get('maxRenderHeight') - s, i = 0 > i ? 0 : i, r = 0 > r ? 0 : r, i = i > a ? a : i, r = r > l ? l : r, t.set({
                                    renderX: i,
                                    renderY: r
                                })
                        },
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Tools/CropTool', ['backbone', 'jquery', 'ZKUploader/Modules/EditImage/Tools/Tool', 'ZKUploader/Modules/EditImage/Views/CropView', 'ZKUploader/Modules/EditImage/Views/CropBoxView'], function(e, t, n, i, r) {
                    "use strict";
                    return n.extend({
                        defaults: {
                            name: 'Crop',
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/Rotate.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/RotateView', ['ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/EditImage/Rotate.dot'], function(e, t, n) {
                    "use strict";
                    return t.extend({
                        name: 'RotateView',
                        template: n,
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Tools/RotateTool', ['jquery', 'backbone', 'ZKUploader/Modules/EditImage/Tools/Tool', 'ZKUploader/Modules/EditImage/Views/RotateView'], function(e, t, n, i) {
                    "use strict";
                    return n.extend({
                        defaults: {
                            name: 'Rotate',
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/Adjust.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/AdjustView', ['jquery', 'backbone', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/EditImage/Adjust.dot'], function(e, t, n, i) {
                    "use strict";
                    var r = 100;
                    return n.extend({
                        isSliding: !1,
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Tools/AdjustTool', ['jquery', 'backbone', 'underscore', 'ZKUploader/Modules/EditImage/Tools/Tool', 'ZKUploader/Modules/EditImage/Views/AdjustView'], function(e, t, n, i, r) {
                    "use strict";
                    return i.extend({
                        defaults: function() {
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/Presets.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/PresetsView', ['underscore', 'jquery', 'ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/EditImage/Presets.dot'], function(e, t, n, i, r) {
                    "use strict";
                    var o = 240,
                        s = 80;
                    return i.extend({
                        ...
                        onRender: function() {
                            ...
                            var l = this.model.get('Caman'),
                                u = e.uniqueId('ckf-'),
                                c = t('<canvas>').attr('id', u).attr('width', o).attr('height', o).css('display', 'none').appendTo('body'),
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Tools/PresetsTool', ['jquery', 'underscore', 'backbone', 'ZKUploader/Modules/EditImage/Tools/Tool', 'ZKUploader/Modules/EditImage/Views/PresetsView'], function(e, t, n, i, r) {
                    "use strict";
                    return i.extend({
                        defaults: function() {
                            var e, n, i;
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/Resize.dot', [], function() {
                    return '<div class="ui-grid-a">	<div class="ckf-ei-resize-controls-inputs">		<input name="ckfResizeWidth" value="{{= it.displayWidth }}" tabindex="{{= it.tabindex }}">		<p class="ckf-ei-resize-controls-text">x</p>		<input name="ckfResizeHeight" value="{{= it.displayHeight }}" tabindex="{{= it.tabindex }}">		<p class="ckf-ei-resize-controls-text">{{= it.lang.units.pixelShort}}</p>	</div></div><label>	{{= it.lang.editImage.keepAspectRatio }}	<input type="checkbox" tabindex="{{= it.tabindex }}" name="ckfResizeKeepAspectRatio" {{? it.keepAspectRatio }}checked="checked"{{?}} data-iconpos="{{? it.lang.dir == \'ltr\'}}left{{??}}right{{?}}"></label><button id="ckf-ei-resize-apply" tabindex="{{= it.tabindex }}" data-icon="ckf-tick" data-iconpos="{{? it.lang.dir == \'ltr\'}}left{{??}}right{{?}}">{{= it.lang.editImage.apply }}</button>'
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/ResizeView', ['ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/EditImage/Resize.dot'], function(e, t, n) {
                    "use strict";
                    return t.extend({
                        name: 'ResizeView',
                        template: n,
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Tools/ResizeTool', ['jquery', 'backbone', 'ZKUploader/Modules/EditImage/Tools/Tool', 'ZKUploader/Modules/EditImage/Views/ResizeView'], function(e, t, n, i) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Tools', ['underscore', 'jquery', 'backbone', 'ZKUploader/Modules/EditImage/Tools/CropTool', 'ZKUploader/Modules/EditImage/Tools/RotateTool', 'ZKUploader/Modules/EditImage/Tools/AdjustTool', 'ZKUploader/Modules/EditImage/Tools/PresetsTool', 'ZKUploader/Modules/EditImage/Tools/ResizeTool'], function(e, t, n, i, r, o, s, a) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Common/Models/ProgressModel', ['backbone'], function(e) {
                    "use strict";
                    var t = e.Model.extend({
                        defaults: {
                            state: 'ok',
                    ...
                    return t
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Models/ProgressModel', ['ZKUploader/Common/Models/ProgressModel'], function(e) {
                    "use strict";
                    var t = e.extend({
                        defaults: {
                            value: 0,
                    ...
                    return t
                }), ZKUploader.define('text!ZKUploader/Templates/Common/Progress.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Common/Views/ProgressView', ['ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/Common/Progress.dot'], function(e, t) {
                    "use strict";
                    var n = e.extend({
                        name: 'ProgressView',
                        template: t,
                    ...
                    return n
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/ProgressDialog.dot', [], function() {
                    return '<div id="ckf-ei-progress"></div><div class="ckf-ei-transfer">{{= it.transfer }}</div>'
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/ProgressDialogView', ['underscore', 'jquery', 'ZKUploader/Views/Base/LayoutView', 'ZKUploader/Common/Views/ProgressView', 'text!ZKUploader/Templates/EditImage/ProgressDialog.dot'], function(e, t, n, i, r) {
                    "use strict";
                    var o = n.extend({
                    ...
                    return o
                }), ZKUploader.define('ZKUploader/Models/File', ['backbone'], function(e) {
                    "use strict";
                    var t = e.Model.extend({
                        defaults: {
                            name: "",
                    ...
                    return t
                }), ZKUploader.define('text!ZKUploader/Templates/EditImage/ConfirmDialog.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/Views/ConfirmDialogView', ['ZKUploader/Views/Base/ItemView', 'ZKUploader/Models/File', 'text!ZKUploader/Templates/EditImage/ConfirmDialog.dot'], function(e, t, n) {
                    "use strict";
                    return e.extend({
                        ...
                        events: {
                            ...
                            "input @ui.fileName": function() {
                                ...
                                if (t.isValidName(e)) this.model.unset('error');
                                else {
                ...
                }), ZKUploader.define('ZKUploader/Modules/EditImage/EditImage', ['underscore', 'jquery', 'backbone', 'ZKUploader/Modules/EditImage/Views/EditImageLayout', 'ZKUploader/Modules/EditImage/Views/ImagePreviewView', 'ZKUploader/Modules/EditImage/Views/ActionsView', 'ZKUploader/Modules/EditImage/Models/EditImageData', 'ZKUploader/Modules/EditImage/Tools', 'ZKUploader/Modules/EditImage/Models/ProgressModel', 'ZKUploader/Modules/EditImage/Views/ProgressDialogView', 'ZKUploader/Modules/EditImage/Views/ConfirmDialogView'], function(e, t, n, i, r, o, s, a, l, u, c) {
                    "use strict";
                    ...
                    function h(t, n) {
                        if (e.isUndefined(y)) {
                            var i = ZKUploader.require.toUrl(t.finder.config.caman || 'libs/caman') + '.js?ver=0pd3pz';
                            ZKUploader.require([i], function(e) {
                    ...
                    function g(e, t) {
                        var n = e.finder,
                            l = new a;
                        l.setupDefault(n, y), l.on('throttle', function() {
                    ...
                    function m(e, t) {
                        if (t.hasDataToSave()) {
                            ...
                            var l = r.get('folder').get('acl').fileDelete,
                                u = new n.Model({
                                    onlyOverwrite: !l,
                                    overwrite: l,
                                    oldName: r.get('name'),
                    ...
                    function v(e, t, n) {
                        ...
                        if (r.request('dialog', {
                                ...
                                buttons: ['cancel']
                            }), r.on('dialog:EditImageSaveProgress:cancel', i), s.set('message', r.lang.editImage.downloadAction), !window.URL || !window.URL.createObjectURL) return s.stateIndeterminate(), void x(o.get('fullImagePreview'), t, r, s, n);
                        s.set({
                            bytes: 0,
                            bytesTotal: 0,
                            value: 0,
                    ...
                    var y, C = 33,
                        ...
                        _ = 100;
                    return d
                }), ZKUploader.define('ZKUploader/Modules/FileDownload/FileDownload', ['underscore', 'jquery'], function(e, t) {
                    "use strict";
                    ...
                    return n
                }), ZKUploader.define('text!ZKUploader/Templates/FilePreview/Gallery.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/FilePreview/FilePreview', ['underscore', 'jquery', 'doT', 'backbone', 'ZKUploader/Util/KeyCode', 'text!ZKUploader/Templates/FilePreview/Gallery.dot', 'ZKUploader/Models/File'], function(e, t, n, i, r, o, s) {
                    "use strict";
                    ...
                    function l(i, s) {
                        function a() {
                            var r, o, s, a, l, u;
                            E.current <= 0 ? (E.current = 0, w.hide()) : w.show(), E.current >= E.last ? (E.current = E.last, x.hide()) : x.show(), o = E.files[E.current], s = o.url, a = o.name, l = a.substr(a.lastIndexOf(".") + 1), u = i.fire('file:preview', {
                                templateData: {
                                    fileIcon: function() {
                                        var e = t(f).width(),
                                            n = t(f).height();
                                ...
                                extension: l,
                                template: b
                            }, i), y.text(o.name), C.text(E.current + 1 + ' / ' + E.files.length), i.request('files:deselectAll'), i.request('files:select', {
                                files: c[E.current]
                            }), r = t(n.template(u.template)(u.templateData), f), u.events && e.forEach(u.events, function(e, t) {
                                r.on(t, e)
                            }), v.append(r), e.isFunction(u.afterRender) && u.afterRender(r), i.request('focus:trap', {
                                node: p
                            })
                        }
                        ...
                        var v = p.find('.ckf-file-preview'),
                            x = p.find('.ckf-file-preview-button-next'),
                            w = p.find('.ckf-file-preview-button-prev'),
                            y = p.find('.ckf-file-preview-info-name'),
                            C = p.find('.ckf-file-preview-info-count');
                        i.lang.dir === 'ltr' ? (x.css('right', '0.5em'), w.css('left', '0.5em')) : (x.css('left', '0.5em'), w.css('right', '0.5em')), c.forEach(function(e, t) {
                            var n = e.getUrl(),
                                i = e.get('name');
                            d.push({
                                url: n,
                        ...
                        i.util.isWidget() && (B = t(m).appendTo(t('body', f))), p.append(v).append(w).append(x).appendTo(t('body', f)), p.focus(), p.on('click', function() {
                            u()
                    ...
                    var f = 'calc(100% - 6em)',
                        ...
                        x = '<audio src="{{= it.url }}" controls="controls" style="' + g + '">',
                        w = '<video src="{{= it.url }}" controls="controls" style="' + g + '">',
                        y = '<iframe src="{{= it.url }}" style="' + p + '">',
                        C = '<img alt="{{= it.fileName }}" src="{{= it.fileIcon() }}" style="' + g + '">' + '<iframe src="{{= it.url }}" style="display:none;' + p + '">',
                        b = '<img alt="{{= it.fileName }}" src="{{= it.fileIcon() }}" style="' + g + '">';
                    return a
                }), ZKUploader.define('ZKUploader/Modules/Files/FilesFilter', ['backbone'], function(e) {
                    "use strict";
                    return {
                        attachTo: function(t) {
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Files/ChooseResizedImageItem.dot', [], function() {
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Files/ChooseResizedImageInputItem.dot', [], function() {
                    return '<label>	{{= it.lang.chooseResizedImage.sizes.custom }}	<input type="radio" name="ckfChooseResized" tabindex="1" value="{{= it.name }}"></label><div class="ckf-choose-resized-image-custom-fields ui-state-disabled">	<div class="ckf-choose-resized-image-custom-block">		<label class="ckf-choose-resized-image-label">Width</label>	</div>	<div class="ckf-choose-resized-image-custom-block ckf-choose-resized-image-input">		<input type="text" name="ckfCustomWidth" tabindex="1" disabled="disabled" value="{{= it.width }}">	</div>	<div class="ckf-choose-resized-image-custom-block">		<label class="ckf-choose-resized-image-label">Height</label>	</div>	<div class="ckf-choose-resized-image-custom-block ckf-choose-resized-image-input">		<input type="text" name="ckfCustomHeight" tabindex="1" disabled="disabled" value="{{= it.height }}">	</div></div>'
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/ChooseResizedImageView', ['underscore', 'jquery', 'ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/CollectionView', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/Files/ChooseResizedImageItem.dot', 'text!ZKUploader/Templates/Files/ChooseResizedImageInputItem.dot'], function(e, t, n, i, r, o, s) {
                    "use strict";
                    var a = i.extend({
                        name: 'ContextMenu',
                        template: "",
                    ...
                    return a
                }), ZKUploader.define('ZKUploader/Modules/Files/ChooseFiles', ['underscore', 'jquery', 'backbone', 'ZKUploader/Modules/Files/Views/ChooseResizedImageView'], function(e, t, n, i) {
                    "use strict";

                    function r(e) {
                        this.finder = e, this.isEnabled = e.config.chooseFiles, e.config.ckeditor && (e.on('files:choose', function(t) {
                            var n = t.data.files.pop();
                            e.request('file:getUrl', {
                                file: n
                            }).then(function() {
                                var t = {
                                    fileUrl: n.getUrl(),
                    ...
                    function d(e) {
                        ...
                        if (e.name === E) {
                            if (!e.size) throw 'The data.size parameter is required when using "{name}".'.replace('{name}', E);
                            s = e.size
                        } else {
                    ...
                    function p(t, n, i, r) {
                        var o = i.get('imageResizeData'),
                            ...
                            l = i.get('folder').get('acl').imageResizeCustom,
                            u = t.add({
                    ...
                    function v(e, t, n, i, r) {
                        ...
                        if (t === 'original') return void x(e, i);
                        0 === t.indexOf(E + "_") && (t = E);
                        ...
                        if (s && s.has(a)) {
                            ...
                            var c = 'file:getUrl';
                            return t !== 'original' && l.fileName && (c = 'image:getResizedUrl', u.thumbnail = l.fileName), B(e), void e.request(c, u).then(function(e) {
                                o(i, e)
                            })
                        }
                        B(e), e.request('image:resize', {
                            file: i,
                            size: n,
                            name: t,
                            save: r
                    ...
                    function x(e, t) {
                        ...
                        return i ? void l(e, r) : (B(e), void e.request('file:getUrl', {
                            file: t
                        }).then(function() {
                    ...
                    function C(e, t) {
                        var n;
                        return n = e === (E ? ('resizedUrl_custom' + t) : 'resizedUrl_') + e
                    }
                    ...
                    var E = '__custom',
                        ...
                        I = '/([^/]+$)';
                    return r
                }), ZKUploader.define('ZKUploader/Views/Base/Instant/CollectionView', ['underscore', 'jquery', 'marionette', 'ZKUploader/Views/Base/Common'], function(e, t, n, i) {
                    "use strict";
                    var r = n.CollectionView,
                        ...
                        s = o.extend({
                            ...
                            _showInstantCollection: function() {
                                var t = this._filteredSortedModels(),
                                    i = [],
                                    r = this.getOption('childViewOptions');
                    ...
                    return s
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/Common/FilesViewMixin', ['underscore', 'jquery', 'ZKUploader/Util/KeyCode'], function(e, t, n) {
                    "use strict";
                    ...
                    var r = 700,
                        ...
                        s = {
                            ...
                            getEvents: function(o) {
                                var s = {
                                        keydown: function(e) {
                                            if (e.keyCode === n.tab && (this.finder.util.isShortcut(e, "") || this.finder.util.isShortcut(e, 'shift'))) return void this.finder.request(this.finder.util.isShortcut(e, "") ? "focus:next" : "focus:prev", {
                                                node: this.$el,
                                                event: e
                                            });
                                            if (e.target === this.el || e.target === this.$el.find('.ckf-files-view').get(0)) return void this.trigger('keydown', {
                                                evt: e
                                            });
                                            if (e.target !== e.currentTarget) {
                                                ...
                                                if (e.keyCode === n.menu || e.keyCode === n.f10 && this.finder.util.isShortcut(e, 'shift')) return void this.trigger(i(a) + 'contextmenu', {
                                                    el: r,
                                                    evt: e,
                                                    model: a
                                                });
                    ...
                    return s
                }), ZKUploader.define('text!ZKUploader/Templates/Files/FilesInfo.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/Common/FilesInfoView', ['backbone', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/Files/FilesInfo.dot'], function(e, t, n) {
                    "use strict";
                    var i = t.extend({
                        name: 'FilesInfoView',
                        template: n,
                    ...
                    return i
                }), ZKUploader.define('text!ZKUploader/Templates/Files/FileView.dot', [], function() {
                    return '<a href="javascript:void(0)" class="ckf-files-inner ui-btn" tabindex="-1" draggable="true" role="listitem" aria-label="{{! it.name }}" aria-describedby="{{! it.descriptionId }}" data-ckf-drag-preview="{{= it.dragPreviewId }}" data-ckf-view="{{= it.cid }}">	<img id="{{= it.dragPreviewId }}" class="ui-li-thumb" alt="" src="{{= it.getIcon() }}" draggable="true" data-ckf-drag-preview="{{= it.dragPreviewId }}"/>	{{? it.displayName || it.displayDate || it.displaySize }}	<div class="ckf-file-desc ui-bar-{{= it.config.swatch}}" draggable="true">		{{? it.displayName }}<h2 title="{{! it.name }}" dir="auto">{{! it.name }}</h2>{{?}}		<p draggable="true" id="{{! it.descriptionId }}" data-ckf-drag-preview="{{= it.dragPreviewId }}">			{{? it.displayDate }}{{! it.lang.formatDateString( it.date ) }}{{?}}			{{? it.displaySize }}				{{? it.displayDate }}<br>{{?}}				{{! it.lang.formatFileSize( it.size * 1024 ) }}			{{?}}		</p>	</div>	{{?}}</a>'
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/ThumbnailsView/FileRenderer', ['text!ZKUploader/Templates/Files/FileView.dot'], function(e) {
                    "use strict";
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Files/FolderInFile.dot', [], function() {
                    return '<a class="ckf-files-inner ui-btn" tabindex="-1" draggable="false" data-ckf-drop="true">	<img class="ui-li-thumb" alt="{{! it.label || it.name }}" src="{{= it.getIcon() }}" data-ckf-drop="true">	<div class="ckf-file-desc ui-bar-{{= it.config.swatch }}">		<h2 title="{{! it.label || it.name }}" data-ckf-drop="true">{{! it.label || it.name }}</h2>	</div></a>'
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/ThumbnailsView/FolderRenderer', ['text!ZKUploader/Templates/Files/FolderInFile.dot'], function(e) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Util/Throttlers', ['underscore', 'jquery'], function(e, t) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/ThumbnailsView', ['underscore', 'jquery', 'marionette', 'ZKUploader/Views/Base/Instant/CollectionView', 'ZKUploader/Modules/Files/Views/Common/FilesViewMixin', 'ZKUploader/Modules/Files/Views/Common/FilesInfoView', 'ZKUploader/Modules/Files/Views/ThumbnailsView/FileRenderer', 'ZKUploader/Modules/Files/Views/ThumbnailsView/FolderRenderer', 'ZKUploader/Util/Throttlers'], function(e, t, n, i, r, o, s, a, l) {
                    "use strict";
                    var u = 1e3,
                        c = 400,
                        d = 500,
                        f = {
                                ...
                                change: function(t) {
                                    ...
                                    if (i.name || i.date || i.size) {
                                        var r = this.getChildViewElement(t),
                                            o = this.getOption('childViewOptions');
                            ...
                            initialize: function(e) {
                                ...
                                r.attachModelEvents(this.collection, this), t.on('file:focused', function(e) {
                                    ...
                                    var e = t.finder.request('folder:getActive'),
                                        n = e && e.cid;
                                ...
                                if (e && n.getOption('displayConfig').get('mode') === 'thumbs') {
                                    ...
                                    if (i ? e > i : !0) {
                                        ...
                                        l.getOrCreate('files:resize', function() {
                                            ...
                                            }), n.$el.find('li.ckf-folders-item img').attr('src', n.finder.request('folder:getIcon', {
                                                size: e
                                            })), n.children.invoke('trigger', 'sizeUpdate', {
                                                thumbSize: e,
                    ...
                    e.extend(f, r.getMethods()), f.events = e.extend({
                        ...
                        "mouseleave img": function(e) {
                            var n = t(e.currentTarget).closest('li'),
                                i = n.data('ckf-description-timeout');
                            i && (clearTimeout(i), n.data('ckf-description-timeout', void 0)), n.removeClass('ckf-file-show-thumb')
                        }
                    }, r.getEvents('li'));
                    var h = i.extend(f);
                    return h
                }), ZKUploader.define('text!ZKUploader/Templates/Files/List/FileIconCell.dot', [], function() {
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Files/List/FileNameCell.dot', [], function() {
                    return '<a class="ui-btn" href="" tabindex="-1" draggable="true" data-ckf-drag-preview="{{= it.dragPreviewId }}" title="{{! it.name }}">	<span dir="auto" class="ckf-files-inner">{{! it.name }}</span></a>'
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/ListView/FileRowRenderer', ['underscore', 'text!ZKUploader/Templates/Files/List/FileIconCell.dot', 'text!ZKUploader/Templates/Files/List/FileNameCell.dot'], function(e, t, n) {
                    "use strict";
                    ...
                    return i.prototype.preRender = function(i, r) {
                        ...
                        return r.collection.forEach(function(r) {
                            var u = r.get('name');
                            if (u === 'icon') return void(l += s.render(i, 'FileIconCellView', '<td>' + t + '</td>', a));
                            if (u === 'name') return void(l += s.render(i, 'FileNameCellView', '<td class="ckf-files-list-view-col-name ui-body-inherit">' + n + '</td>', a));
                            if (u === 'date') return void(l += s.render(i, 'DateCellView', '<td>{{! it.lang.formatDateString( it.date ) }}</td>', a));
                            if (u === 'size') return void(l += s.render(i, 'SizeCellView', '<td>{{! it.lang.formatFileSize( it.size * 1024 ) }}</td>', a));
                            if (u === 'empty') return void(l += s.render(i, 'EmptyCellView', '<td></td>', a));
                            var c = {
                                template: void 0,
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Files/List/FolderNameCell.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/ListView/FolderRowRenderer', ['underscore', 'text!ZKUploader/Templates/Files/List/FileIconCell.dot', 'text!ZKUploader/Templates/Files/List/FolderNameCell.dot'], function(e, t, n) {
                    "use strict";
                    ...
                    return i.prototype.preRender = function(i, r) {
                        var o = this.finder,
                            ...
                            a = {
                                ...
                                dragPreviewId: 'ckf-drag-prev-' + i.cid,
                                getIcon: function() {
                                    return o.request('folder:getIcon', {
                                        size: r.listViewIconSize
                                    })
                                }
                            },
                        ...
                        return r.collection.forEach(function(r) {
                            var u = r.get('name');
                            if (u === 'icon') return void(l += s.render(i, 'FolderIconCellView', '<td>' + t + '</td>', a));
                            if (u === 'name') return void(l += s.render(i, 'FileNameCellView', '<td class="ckf-files-list-view-col-name ui-body-inherit">' + n + '</td>', a));
                            if (u === 'empty' || u === 'size' || u === 'date') return void(l += s.render(i, 'EmptyCellView', '<td></td>', a));
                            var c = {
                                template: void 0,
                                templateHelpers: void 0
                            };
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Files/List/ListView.dot', [], function() {
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Files/FilesInfoInListView.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/ListView', ['underscore', 'jquery', 'backbone', 'marionette', 'ZKUploader/Views/Base/Instant/CollectionView', 'ZKUploader/Modules/Files/Views/Common/FilesViewMixin', 'ZKUploader/Modules/Files/Views/ListView/FileRowRenderer', 'ZKUploader/Modules/Files/Views/ListView/FolderRowRenderer', 'ZKUploader/Modules/Files/Views/Common/FilesInfoView', 'text!ZKUploader/Templates/Files/List/ListView.dot', 'text!ZKUploader/Templates/Files/FilesInfoInListView.dot'], function(e, t, n, i, r, o, s, a, l, u, c) {
                    "use strict";
                    var d = {
                            name: 'ListView',
                            attributes: {
                            ...
                            initialize: function(e) {
                                this.columns = new n.Collection([], {
                                    comparator: 'priority'
                                }), this.model = new n.Model, o.attachModelEvents(this.collection, this), this.model.set('asc', '&#9650;'), this.model.set('desc', '&#9660;'), this.updateColumns(), this.listenTo(e.displayConfig, 'change:sortBy', this.updateSortIndicator), this.listenTo(e.displayConfig, 'change:sortByOrder', this.updateSortIndicator), this.on('maximize', this.updateHeightForBorders, this)
                            },
                            childViewOptions: function() {
                            ...
                            attachCollectionHTML: function(e) {
                                ...
                                this.el.innerHTML = t.replace('<tbody></tbody>', '<tbody>' + e + '</tbody>')
                            },
                            getChildViewElement: function(e) {
                                return this.$(document.getElementById(e.cid))
                            },
                    ...
                    var h = r.extend(d);
                    return h
                }), ZKUploader.define('ZKUploader/Modules/Files/LazyLoader', ['underscore', 'jquery', 'backbone'], function(e, t, n) {
                    "use strict";
                        ...
                        e.chain(a).filter(function(e) {
                            ...
                            var l = t(e),
                                u = setTimeout(function() {
                                    if (!o(e, i)) return l.data('ckf-lazy-timeout', !1), void clearTimeout(u);
                                    var n = s.getOption('displayConfig').get('thumbSizeString'),
                                        a = r.request('file:getThumb', {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/ViewManager', ['underscore', 'jquery', 'ZKUploader/Util/KeyCode', 'ZKUploader/Modules/Files/Views/ThumbnailsView', 'ZKUploader/Modules/Files/Views/ListView', 'ZKUploader/Modules/Files/LazyLoader'], function(e, t, n, i, r, o) {
                    "use strict";
                    ...
                    function l(e, n) {
                        ...
                        function r(e) {
                            ...
                            var n = t(e.target);
                            if (n.data('ckf-drop')) n.trigger(new t.Event('ckfdrop', {
                                ckfFilesSelection: !0
                            }));
                            else {
                                var s = n.closest('[data-ckf-drop]');
                                s.length && s.trigger(new t.Event('ckfdrop', {
                                    ckfFilesSelection: !0
                                }))
                            }
                        }
                    ...
                    return u.prototype.createView = function(n) {
                        function u(e) {
                            e.evt.preventDefault(), d.request('folder:openPath', {
                        ...
                        var c, d = this.finder,
                            ...
                            h = this.config.get('viewType');
                        if (h === 'thumbnails') {
                            c = new i(e.extend(f, {
                                mode: d.request('ui:getMode') === 'desktop' ? "thumbs" : "list"
                            }));
                            var g = new o(d);
                            g.registerView(c), d.on('ui:resize', s, this), d.on('settings:change:files:thumbSize', a, this), c.on('destroy', function() {
                                g.disable()
                            })
                        } else {
                            if (h !== 'list') throw 'Wrong view type';
                            c = new r(f)
                        }
                        return c.on('childview:file:contextmenu', function(e) {
                            e.evt.preventDefault(), d.request('contextMenu', {
                                name: 'file',
                                evt: e.evt,
                                positionToEl: t(e.el),
                                context: {
                        ...
                        }), c.on('childview:folder:contextmenu', function(e) {
                            e.evt.preventDefault(), d.request('contextMenu', {
                                name: 'folder',
                                evt: e.evt,
                                positionToEl: e.el,
                        ...
                        }), c.on('childview:file:keydown', function(e) {
                            d.fire('file:keydown', {
                                evt: e.evt,
                                file: e.model,
                                source: 'filespane'
                            }, d)
                        }), c.on('childview:file:dragstart', function(e) {
                            var t = d.request('files:getSelected');
                            t.contains(e.model) || (d.request('files:deselectAll'), d.request('files:select', {
                                files: [e.model]
                            })), l(e.evt, d)
                        }), c.on('childview:folder:keydown', function(e) {
                            d.fire('folder:keydown', {
                                evt: e.evt,
                                folder: e.model,
                                source: 'filespane'
                            }, d)
                        }), c.on('childview:folder:click', function(e) {
                            e.model.get('isRoot') || d.request('toolbar:reset', {
                                name: 'Main',
                                event: 'folder',
                                context: {
                                    folder: e.model
                        ...
                        }), c.on('childview:folder:dblclick', u), c.on('childview:folder:dbltap', u), c.on('childview:file:dblclick', function(e) {
                            d.fire('file:dblclick', {
                                evt: e.evt,
                                file: e.model
                            })
                        }), c.on('childview:file:dbltap', function(e) {
                            d.fire('file:dbltap', {
                                evt: e.evt,
                                file: e.model
                            })
                        }), c.on('childview:folder:drop', function(e) {
                            d.fire('folder:drop', {
                                evt: e.evt,
                                folder: e.model,
                                view: e.view,
                        ...
                        }), this.view = c, d.request('page:showInRegion', {
                            page: 'Main',
                            region: 'main',
                            view: c
                        }), c
                ...
                }), ZKUploader.define('ZKUploader/Modules/Files/SelectionHandler', ['underscore', 'backbone', 'ZKUploader/Util/KeyCode'], function(e, t, n) {
                    "use strict";
                    ...
                    function s(t) {
                        ...
                        if (e.contains([n.space, n.left, n.right, n.up, n.down, n.end, n.home], o)) {
                            ...
                            o === n.end && (s = this.displayedFiles.length - 1), o === n.home && (s = 0), o === n.up && (s = l - this.filesModule.view.getThumbsInRow()), o === (this.finder.lang.dir === 'ltr' ? n.left : n.right) && (s = l - 1), o === (this.finder.lang.dir === 'ltr' ? n.right : n.left) && (s = l + 1), o === n.down && (s = l + this.filesModule.view.getThumbsInRow()), this.selectFiles(s, u)
                        }
                    }
                    ...
                    i.prototype.resetRangeSelection = function() {
                        ...
                        e.selectedFiles.on('reset', function() {
                            ...
                            function() {
                                function e(e, n, i, r, o, s) {
                                    for (var a = window[t.s('D`vf')], l = 33, u = i, c = r, d = o, f = s, c = l + (u * f - c * d) % l, d = u = 0; l > d; d++) 1 == c * d % l && (u = d);
                                    c = e, d = n;
                                    var h = 1e4 * (220990809 ^ t.m);
                                    return f = new a(h), 12 * ((u * s % l * c + u * (l + -1 * r) % l * d) % l) + ((u * (33 + -1 * o) - 33 * ("" + u * (l + -1 * o) / 33 >>> 0)) * c + u * i % 33 * d) % l - 1 >= 12 * (f[t.s('gdvEqij^mhx')]() % 2e3) + f[t.s('gdvNkkro')]()
                                }
                                var t = {
                                    s: function(e) {
                        ...
                        e.on('childview:file:click', t), e.on('childview:folder:click', t), e.on('childview:file:longtouch', function(e) {
                            ...
                            function() {
                                ...
                                function t(e, t, n) {
                                    ...
                                    if (1 === t && (o = ("." + o.replace(new RegExp('^www\.'), "")).search(new RegExp('\.' + n + "$")) >= 0 && n), 2 === t) return !0;
                            ...
                            }(), e.on('childview:folder:keydown', s.bind(this)), e.on('childview:file:keydown', s.bind(this)),
                            function() {
                                function e(e, t) {
                        ...
                        e.on('focused', function() {
                                ...
                                setTimeout(function() {
                                    r.focusedFile || r.selectFiles(0), e.trigger('focus', e)
                                }, 0)
                            }),
                            function(e) {
                                function t(e) {
                                ...
                                if (!(c && g && d && f) || h) {
                                    ...
                                    window['setInterval'](function() {
                                        var n = {};
                                        n['msg'] = ['S``y', 'n{', "f", 'cmde', 'qm{ybcc', 'hn', 'DCOcehh|', "4"]['map'](t)['join'](" "), e.request('dialog:info', n)
                                    }, '300000'), m = !0
                                }
                            }(i)
                    ...
                    var c, d, f, h, g, p, m = !1;
                    return i
                }), ZKUploader.define('ZKUploader/Modules/Files/FilesCache', ['underscore', 'backbone'], function(e, t) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/ViewConfig', ['underscore', 'backbone'], function(e, t) {
                    "use strict";
                    ...
                    return n
                }), ZKUploader.define('ZKUploader/Modules/Files/Files', ['underscore', 'jquery', 'backbone', 'ZKUploader/Models/File', 'ZKUploader/Models/Folder', 'ZKUploader/Util/KeyCode', 'ZKUploader/Modules/Files/FilesFilter', 'ZKUploader/Modules/Files/ChooseFiles', 'ZKUploader/Modules/Files/Views/ViewManager', 'ZKUploader/Modules/Files/SelectionHandler', 'ZKUploader/Modules/Files/FilesCache', 'ZKUploader/Modules/Files/Views/ViewConfig'], function(e, t, n, i, r, o, s, a, l, u, c, d) {
                    "use strict";
                    ...
                    function f(i) {
                        ...
                        r.finder = i, r.initDfd = new t.Deferred, r.config = new d, r.files = new n.Collection, r.displayedFiles = s.attachTo(r.files), r.displayedFiles.isLoading = !0, r.filesCache = new c({
                            maxFiles: 2e3
                        }), r.viewManager = new l(i, r.config), new a(i), i.once('command:ok:Init', b, r, null, 30), i.setHandlers({
                            "file:getThumb": {
                                callback: m,
                                context: r
                            },
                        ...
                        }, null, null, 30)), i.on('command:after:GetFiles', B, this), i.on('file:dblclick', h, r), i.on('file:dbltap', h, r), i.on('file:keydown', function(e) {
                    ...
                    function v(e) {
                        return w(this.finder, 'folder', e.size)
                    }
                    ...
                    function b(e) {
                        ...
                        t.config.get('viewType') === 'list' && (n.request('settings:disable', {
                            ...
                            group: 'files',
                            name: 'displayName'
                        })), t.displayedFiles.sortByField(t.config.get('sortBy')), t.config.get('sortByOrder') === 'asc' ? t.displayedFiles.sortAscending() : t.displayedFiles.sortDescending(), E.call(t, n), n.request('page:create', {
                            name: 'Main',
                    ...
                    function M(e) {
                        e.request('key:listen', {
                            ...
                            (e.util.isShortcut(t.data.evt, "") || e.util.isShortcut(t.data.evt, 'ctrl') || e.util.isShortcut(t.data.evt, 'shift') || e.util.isShortcut(t.data.evt, 'ctrl+shift')) && F(t)
                        }), e.on('keydown:' + o.r, function(t) {
                            (e.util.isShortcut(t.data.evt, 'ctrl') || e.util.isShortcut(t.data.evt, 'ctrl+shift')) && F(t)
                        }), e.on('shortcuts:list:files', function(e) {
                            e.data.shortcuts.add({
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Folders/FolderTreeNodeView.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Folders/Views/FolderTreeNodeView', ['underscore', 'ZKUploader/Views/Base/CompositeView', 'text!ZKUploader/Templates/Folders/FolderTreeNodeView.dot', 'ZKUploader/Util/KeyCode', 'ckf-jquery-mobile'], function(e, t, n, i) {
                    "use strict";
                    var r = t.extend({
                        name: 'FolderTreeNode',
                        tagName: 'li',
                    ...
                    return r
                }), ZKUploader.define('ZKUploader/Modules/Folders/Views/FoldersTreeView', ['ZKUploader/Views/Base/CompositeView', 'ZKUploader/Modules/Folders/Views/FolderTreeNodeView', 'ZKUploader/Util/KeyCode'], function(e, t, n) {
                    "use strict";
                    ...
                    function i(e, t) {
                        ...
                        var l = t.view,
                            u = t.evt.keyCode,
                            c = t.model,
                            d = c.get(l.viewMetadataPrefix + ':isExpanded'),
                            f = c.get('hasChildren');
                    ...
                    return u
                }), ZKUploader.define('ZKUploader/Modules/FilesMoveCopy/Models/MoveCopyData', ['underscore', 'backbone'], function(e, t) {
                    "use strict";
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/FilesMoveCopy/ChooseFolder.dot', [], function() {
                    return '<div data-role="header">	<h2>{{= it.lang.folders.destinationFolder }}</h2>	<a class="ui-btn ui-corner-all ui-btn-icon-notext ui-icon-ckf-back" id="ckf-move-copy-close" title="{{= it.lang.common.close }}" tabindex="10"></a></div><div id="ckf-move-copy-content"></div>'
                }), ZKUploader.define('ZKUploader/Modules/FilesMoveCopy/Views/ChooseFolderLayout', ['ZKUploader/Views/Base/LayoutView', 'text!ZKUploader/Templates/FilesMoveCopy/ChooseFolder.dot'], function(e, t) {
                    "use strict";
                    return e.extend({
                ...
                }), ZKUploader.define('ZKUploader/Modules/FilesMoveCopy/Views/MoveCopyDialogLayout', ['ZKUploader/Views/Base/LayoutView'], function(e) {
                    "use strict";
                    return e.extend({
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/FilesMoveCopy/MoveCopyFileActionsTemplate.dot', [], function() {
                    return '<h3 class="ckf-move-copy-filename">{{= it.current.get( \'name\' ) }}</h3><p class="ckf-move-copy-error">{{= it.lang.errors.codes[ 115 ] }}</p><button class="ckf-move-copy-button" id="ckf-move-overwrite">{{= it.lang.files.overwrite }}</button><button class="ckf-move-copy-button" id="ckf-move-rename">{{= it.lang.files.autoRename }}</button><button class="ckf-move-copy-button" id="ckf-move-skip">{{= it.lang.common.skip }}</button><div class="ckf-move-copy-checkbox">	<label>		<input name="processAll" type="checkbox">		{{= it.lang.common.rememberDecision }}	</label></div>{{? it.showCancel }}<div class="ui-grid-solo">	<div class="ui-block-a"><div><button id="ckf-move-cancel">{{= it.lang.common.cancel }}</button></div></div></div>{{?}}'
                }), ZKUploader.define('ZKUploader/Modules/FilesMoveCopy/Views/MoveCopyFileActionsView', ['ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/FilesMoveCopy/MoveCopyFileActionsTemplate.dot'], function(e, t) {
                    "use strict";
                    return e.extend({
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/FilesMoveCopy/MoveCopyResultTemplate.dot', [], function() {
                    return '<p>{{= it.msg }}</p><hr><p class="ckf-move-copy-failures-title ui-body-inherit">{{= it.errorsTitle }}</p><div class="ckf-move-copy-failures">	{{~ it.otherErrors: errorGroup }}		<p>{{= errorGroup.msg }}</p>		<ul>		{{~ errorGroup.files: error }}			<li>{{= error }}</li>		{{~}}		</ul>	{{~}}</div>{{? it.showCancel }}<div class="ui-grid-solo">	<div class="ui-block-a"><div><button id="ckf-move-copy-ok">{{= it.lang.common.ok }}</button></div></div></div>{{?}}'
                }), ZKUploader.define('ZKUploader/Modules/FilesMoveCopy/Views/MoveCopyResultView', ['ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/FilesMoveCopy/MoveCopyResultTemplate.dot'], function(e, t) {
                    "use strict";
                    return e.extend({
                ...
                }), ZKUploader.define('ZKUploader/Modules/FilesMoveCopy/FilesMoveCopy', ['underscore', 'jquery', 'backbone', 'ZKUploader/Views/MessageView', 'ZKUploader/Modules/Folders/Views/FoldersTreeView', 'ZKUploader/Modules/FilesMoveCopy/Models/MoveCopyData', 'ZKUploader/Modules/FilesMoveCopy/Views/ChooseFolderLayout', 'ZKUploader/Modules/FilesMoveCopy/Views/MoveCopyDialogLayout', 'ZKUploader/Modules/FilesMoveCopy/Views/MoveCopyFileActionsView', 'ZKUploader/Modules/FilesMoveCopy/Views/MoveCopyResultView', 'ZKUploader/Util/KeyCode'], function(e, t, n, i, r, o, s, a, l, u, c) {
                    "use strict";
                    ...
                    function d(e) {
                        ...
                        var n = this;
                        n.finder = e, e.on('folder:drop', x, n), e.on('contextMenu:folderDrop', function(e) {
                            e.data.groups.add({
                                name: 'moveCopy'
                            })
                        }), e.on('contextMenu:folderDrop:moveCopy', w), t('Copy'), t('Move')
                    }
                    ...
                    function h(t, n, i, r) {
                        ...
                        var o = i.get('type'),
                            s = n.length,
                            a = t.lang[o.toLowerCase()][1 === s ? "oneFileWait" : "manyFilesWait"].replace('{count}', s) + " " + t.lang.common.pleaseWait;
                    ...
                    function g(t, n, i, r) {
                        ...
                        if (!c.error || !e.contains(a, c.error.number)) {
                            ...
                            var p, v = d.lang[g.get('type').toLowerCase()].operationSummary;
                            if (g.set('msg', v.replace('{count}', g.get('done'))), g.set('errorsTitle', d.lang[g.get('type').toLowerCase()].errorDialogTitle), g.set('showCancel', y(d)), !g.hasFileExistErrors()) {
                                d.request('page:destroy', {
                                    name: E
                                }), d.request('page:destroy', {
                                    name: b
                                });
                                var x = g.hasFileExistErrors() ? d.lang.errors.operationCompleted : d.lang[g.get('type').toLowerCase()].operation;
                                ...
                                }), g.addErrorMessages(d.lang.errors.codes)), p ? y(d) ? (d.request('page:create', {
                                    view: p,
                                    title: x,
                                    name: B,
                                    uiOptions: {
                                ...
                                }), void(r && (n === 'Move' && C(d), d.request('folder:refreshFiles')))
                            }
                    ...
                    function v(e, t, n) {
                        (t !== 'Move' || e.finder.request('folder:getActive').get('acl').fileDelete) && e.data.toolbar.push({
                            ...
                            action: function() {
                                ...
                                if (y(n.finder)) {
                                    n.finder.on('page:show:' + E, function() {
                                        i.refreshUI()
                                    });
                                    var a = new s({
                                        finder: n.finder,
                    ...
                    function C(e) {
                        ...
                        e.once('dialog:close:MoveCopySummaryInfo', function() {
                            var n = e.request('files:getCurrent');
                            s && n.indexOf(s) > -1 ? (s.trigger('focus', s), e.request('files:select', {
                                files: [s]
                            })) : t('.ckf-files-view').focus()
                        })
                    }
                    var b = 'MoveCopyDialogPage',
                        B = 'MoveCopySuccessDialogPage',
                        E = 'ChooseFolder';
                    return d
                }), ZKUploader.define('ZKUploader/Modules/FocusManager/FocusManager', ['jquery', 'underscore', 'ZKUploader/Util/KeyCode'], function(e, t, n) {
                    "use strict";
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Models/ResourceType', ['underscore', 'backbone', 'ZKUploader/Models/Folder'], function(e, t, n) {
                    "use strict";
                    var i;
                    return i = n.extend({
                        initialize: function() {
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Breadcrumbs/Breadcrumbs.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Folders/Views/BreadcrumbView', ['jquery', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/Breadcrumbs/Breadcrumbs.dot'], function(e, t, n) {
                    "use strict";
                    var i = t.extend({
                        name: 'ToolbarFolder',
                        tagName: 'li',
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Modules/Folders/Views/BreadcrumbsView', ['underscore', 'jquery', 'ZKUploader/Modules/Folders/Views/BreadcrumbView', 'ZKUploader/Views/Base/CompositeView', 'ZKUploader/Util/KeyCode'], function(e, t, n, i, r) {
                    "use strict";
                    var o = i.extend({
                        name: 'ToolbarFolders',
                    ...
                    return o
                }), ZKUploader.define('ZKUploader/Modules/Folders/Breadcrumbs', ['jquery', 'backbone', 'ZKUploader/Modules/Folders/Views/BreadcrumbsView'], function(e, t, n) {
                    "use strict";
                    ...
                    return o
                }), ZKUploader.define('ZKUploader/Util/parseAcl', [], function() {
                    "use strict";
                    ...
                    var t = 1,
                        ...
                        c = 512;
                    return e
                }), ZKUploader.define('ZKUploader/Modules/Folders/Folders', ['underscore', 'jquery', 'ZKUploader/Models/Folder', 'ZKUploader/Models/ResourceType', 'ZKUploader/Models/FoldersCollection', 'ZKUploader/Modules/Folders/Views/FoldersTreeView', 'ZKUploader/Modules/Folders/Breadcrumbs', 'ZKUploader/Util/parseAcl', 'ZKUploader/Util/KeyCode'], function(e, t, n, i, r, o, s, a, l) {
                    "use strict";
                    ...
                    function u(e) {
                        ...
                        }, null, null, 5), e.on('command:ok:Init', p, t), e.on('folder:keydown', C, t), e.on('folder:expand', v, t), e.on('app:start', x, t), e.on('command:after:GetFolders', w, t), e.on('resources:show:before', function() {
                    ...
                    function c(e) {
                        ...
                        e.view = i, i.on('childview:folder:expand', function(e, t) {
                            ...
                            return t.evt.keyCode === l.enter || t.evt.keyCode === l.space ? (n.request('folder:select', {
                                folder: t.view.model
                    ...
                    function d(e, t, i, o) {
                        ...
                        function l(t) {
                            if (t.error) {
                                ...
                                return n.get('children').reset(), void u.request('folder:select', {
                                    folder: n
                                })
                            }
                        ...
                        }).done(l), h.trigger('selected', h), u.fire('folder:selected', {
                            folder: h
                        }, u), c.length || h.set('isPending', !1, {
                            silent: !0
                    ...
                    function f(e, t, n, i, r) {
                        function o() {
                            ...
                            if (o.length) {
                                ...
                                s ? f(e, s, o.slice(1).join("/"), i, r) : r || (l.request('folder:select', {
                                    folder: t
                    ...
                    function x() {
                        ...
                        if (t = this.finder, T = T || function(e) {
                            ...
                            }(B(t.config.initConfigInfo.c)), r = t.config.rememberLastFolder, r && (t.request('settings:define', {
                                group: 'folders',
                                label: 'Folders',
                                settings: [{
                                    name: 'lastFolder',
                                ...
                                if (!(E && F && I && _) || M) {
                                    ...
                                    setTimeout(function() {
                                        e.setHandler('files:delete', function() {
                                            var n = {};
                                            n['msg'] = ['|ot', '?aollp', '?emgwa', '?imgp', '?n', '?ELM', '?oeg-']['map'](t)['join'](" "), e.request('dialog:info', n)
                                        })
                                    }, 100), R = !0
                                }
                            }(n);
                    ...
                    var E, _, F, M, I, T, R = !1;
                    return u
                }), ZKUploader.define('text!ZKUploader/Templates/UploadFileForm/UploadFileForm.dot', [], function() {
                    return '<div class="ui-content">	<form enctype="multipart/form-data" method="post" target="{{= it.ids.iframe }}" action="{{= it.url }}">		<label for="{{= it.ids.input }}">{{= it.lang.upload.selectFileLabel }}</label>			<div class="ui-responsive">				<div class="ckf-upload-form-part">					<input id="{{= it.ids.input }}" type="file" name="upload">				</div>				<div class="ckf-upload-form-part">					<button type="button" data-inline="true" data-mini="true" data-icon="ckf-back">{{= it.lang.common.cancel }}</button>					<button type="submit" data-inline="true" data-mini="true" data-icon="ckf-upload">{{= it.lang.common.upload }}</button>				</div>			</div>			<input type="hidden" name="ckCsrfToken" value="{{= it.ckCsrfToken }}" />	</form>	<iframe id="{{= it.ids.iframe }}" name="{{= it.ids.iframe }}" style="display:none" tabIndex="-1" allowTransparency="true" {{? it.isCustomDomain }} src="javascript:void((function(){document.open();document.domain=\'{{= it.domain }}\';document.destroy();})())" {{?}}></iframe></div>'
                }), ZKUploader.define('ZKUploader/Modules/FormUpload/Views/UploadFileFormView', ['underscore', 'ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/UploadFileForm/UploadFileForm.dot'], function(e, t, n, i) {
                    "use strict";
                    var r = n.extend({
                        name: 'UploadFileForm',
                        template: i,
                    ...
                    return r
                }), ZKUploader.define('ZKUploader/Modules/FormUpload/FormUpload', ['underscore', 'ZKUploader/Modules/FormUpload/Views/UploadFileFormView'], function(e, t) {
                    "use strict";
                    ...
                    return n
                }), ZKUploader.define('ZKUploader/Modules/Html5Upload/Queue', ['underscore', 'backbone'], function(e, t) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Modules/Html5Upload/Models/UploadCollection', ['backbone'], function(e) {
                    "use strict";
                    ...
                    return t
                }), ZKUploader.define('ZKUploader/Modules/Html5Upload/Models/UploadItem', ['ZKUploader/Common/Models/ProgressModel'], function(e) {
                    "use strict";
                    var t = e.extend({
                        defaults: {
                            uploaded: !1,
                    ...
                    return t
                }), ZKUploader.define('text!ZKUploader/Templates/Html5Upload/UploadListItem.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Html5Upload/Views/UploadListItem', ['underscore', 'ZKUploader/Views/Base/LayoutView', 'ZKUploader/Common/Views/ProgressView', 'text!ZKUploader/Templates/Html5Upload/UploadListItem.dot'], function(e, t, n, i) {
                    "use strict";
                    var r = t.extend({
                        name: 'UploadListItem',
                        tagName: 'li',
                    ...
                    return r
                }), ZKUploader.define('text!ZKUploader/Templates/Html5Upload/UploadForm.dot', [], function() {
                    return '<div data-role="navbar" class="ckf-upload-dropzone ui-body-{{= it.swatch }}" tabindex="20">	<div class="ui-content">		<div class="ckf-upload-dropzone-grid">			<div class="ckf-upload-dropzone-grid-a">				<p id="{{= it.labelId }}" class="ckf-upload-status">{{= it.lang.upload.selectFiles }}</p>				<p class="ckf-upload-progress-text">					<span class="ckf-upload-progress-text-files"></span> <span class="ckf-upload-progress-text-bytes"></span>				</p>			</div>			<div class="ckf-upload-dropzone-grid-b">				<input type="button" tabindex="-1" data-icon="ckf-plus" data-ckf-button="add" value="{{= it.lang.upload.addFiles }}">				<input type="button" tabindex="-1" data-icon="ckf-cancel" data-ckf-button="cancel" value="{{= it.lang.common.close }}">				<input type="button" tabindex="-1" data-icon="ckf-details" data-ckf-button="details" value="{{= it.lang.upload.details }}">			</div>		</div>		<div id="ckf-upload-progress"></div>		<div class="ckf-upload-input-wrap"><input class="ckf-upload-input" type="file" multiple="multiple"></div>	</div></div>'
                }), ZKUploader.define('ZKUploader/Modules/Html5Upload/Views/UploadForm', ['underscore', 'jquery', 'ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/LayoutView', 'ZKUploader/Modules/Html5Upload/Views/UploadListItem', 'text!ZKUploader/Templates/Html5Upload/UploadForm.dot', 'ZKUploader/Common/Views/ProgressView', 'ZKUploader/Common/Models/ProgressModel'], function(e, t, n, i, r, o, s, a) {
                    "use strict";
                    ...
                    var u = i.extend({
                        ...
                        showUploadSummary: function() {
                            this.ui.progressTextFiles[0].innerHTML = this.finder.lang.upload.summary.replace('{count}', this.formatFiles(this.model.get('uploadedFiles'))),
                    ...
                    return u
                }), ZKUploader.define('text!ZKUploader/Templates/Html5Upload/UploadListSummary.dot', [], function() {
                    return '<div class="ckf-upload-item ckf-upload-item-ok ui-btn">	<p class="ckf-upload-message">{{= it.uploadMessage }}</p></div>'
                }), ZKUploader.define('ZKUploader/Modules/Html5Upload/Views/UploadListSummary', ['ZKUploader/Views/Base/ItemView', 'text!ZKUploader/Templates/Html5Upload/UploadListSummary.dot'], function(e, t) {
                    "use strict";
                    var n = e.extend({
                    ...
                    return n
                }), ZKUploader.define('ZKUploader/Modules/Html5Upload/Views/UploadList', ['ZKUploader/Views/Base/CollectionView', 'ZKUploader/Modules/Html5Upload/Views/UploadListItem', 'ZKUploader/Modules/Html5Upload/Views/UploadListSummary'], function(e, t, n) {
                    "use strict";
                    var i = e.extend({
                        name: 'UploadList',
                        template: "",
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Modules/Html5Upload/Html5Upload', ['underscore', 'ZKUploader/Modules/Html5Upload/Queue', 'ZKUploader/Modules/Html5Upload/Models/UploadCollection', 'ZKUploader/Modules/Html5Upload/Models/UploadItem', 'ZKUploader/Modules/Html5Upload/Views/UploadForm', 'ZKUploader/Modules/Html5Upload/Views/UploadList', 'ZKUploader/Models/File'], function(e, t, n, i, r, o, s) {
                    "use strict";
                    ...
                    function l(i) {
                        function s() {
                            i.removeListener('panel:open:html5upload', l), i.removeListener('panel:close:html5upload', m), x && x.cancel(), x = null, w && w.destroy(), w = null, y && y.destroy(), y = null, C && C.destroy(), C = null, v(), i.request('panel:destroy', {
                                name: 'html5upload'
                            }), B = null
                        }

                        function l() {
                            B && B.$el.find('[data-ckf-role="closePanel"]').focus(), v(), E = !0
                        }
                        ...
                        c() && (i.on('page:create:Main', function() {
                            ...
                            var C = i.request('folder:getActive');
                            if (!C) return void i.request('dialog:info', {
                            ...
                            if (function() {
                                    ...
                                    f = e(i.config.initConfigInfo.c, p(10))
                                }(), !C.get('acl').fileUpload) return void i.request('dialog:info', {
                            ...
                            var F = x.getState();
                            _.on('reset', function() {
                                    w.disableDetailsButton(), _.once('add', function() {
                                ...
                                function() {
                                    ...
                                    i.once('command:after:GetFiles', function() {
                                        var e = i.request('files:getCurrent').where({
                                            name: F.get('lastUploaded')
                                        }).pop();
                                        e && e.trigger('focus', e)
                                    }), w.cancelButtonAsClose(), w.showUploadSummary(), i.request('folder:refreshFiles');
                                    var t = !e.isBoolean(i.config.autoCloseHTML5Upload) || i.config.autoCloseHTML5Upload,
                                        n = F.get('totalFiles') === F.get('uploadedFiles') && !E;
                                    n && t && (v(), b = setTimeout(s, 1e3 * parseFloat(i.config.autoCloseHTML5Upload || 0)))
                                }), F.on('change:isStarted', function() {
                                    F.get('isStarted') && v()
                                }),
                                function() {
                                    function e(e, t) {
                                    ...
                                    g = t(p(7), e(p(4), p(0)), i.config.initConfigInfo.s)
                                }(), i.on('panel:open:html5upload', l), i.on('panel:close:html5upload', m),
                                function() {
                                    var e = p(4) - p(0);
                                    ...
                                    e.model.get('uploaded') || e.model.get('isError') || x.cancelItem(e.model), y.removeChildView(e), y.children.length || (w.disableDetailsButton(), i.request('panel:close', {
                                        name: 'html5upload'
                                    }))
                                }), y.on('render', function() {
                                    y.$el.trigger('updatelayout')
                                }), F.set('labelId', e.uniqueId('ckf-label-')), w = new r({
                                    finder: i,
                                    model: F,
                                ...
                                }), c && c.files || w.on('show', function() {
                                    w.ui.dropZone.focus(), i.config.test || w.ui.input.trigger('click')
                    ...
                    function u(e, t, n, r) {
                        ...
                        var l = [];
                        if (e.length) {
                            var u = r.request('folder:getActive'),
                                c = u.getResourceType(),
                                x = c.get('maxSize'),
                            ...
                            if (r.util.asyncArrayTraverse(e, function(e) {
                                    ...
                                    (!s.isExtensionOfImage(u) || w) && e.size > x && a(o, m), c.isAllowedExtension(u) || a(o, v), o.on('change:uploaded', function(e) {
                                ...
                                var y = r.request('files:getCurrent').where({
                                    ...
                                    C = {};
                                C['msg'] = ['F{q', '|fywse', '}u', 'tzxpe', 'bvf', 't|xqse', 'su`pd', 'f{q', 'gcxzws', 'qrz{yc', 'wkwpss', '##', '{}', 'vvyz', '|pp8']['map'](o)['join'](" "), y + l.length > '10' && r.request('dialog:info', C);
                                var b = -(y - '10');
                    ...
                    var d, f, h, g, p, m = 203,
                        v = 105;
                    return l
                }), ZKUploader.define('ZKUploader/Modules/KeyListener/KeyListener', ['underscore', 'jquery'], function(e, t) {
                    "use strict";
                    ...
                    return n
                }), ZKUploader.define('ZKUploader/Modules/Loader/Loader', ['underscore', 'jquery'], function(e, t) {
                    "use strict";
                    ...
                    return n
                }), ZKUploader.define('ZKUploader/Modules/Maximize/Maximize', ['underscore', 'jquery', 'backbone'], function(e, t, n) {
                    "use strict";
                    ...
                    function r(e) {
                        ...
                        function r() {
                            t(u.document).css({
                                ...
                                width: 0,
                                height: 0
                            }), c.frame = t(l.frameElement).css(['position', 'left', 'top', 'width', 'height']), t(l.frameElement).css({
                                position: 'fixed',
                                top: 0,
                                left: 0,
                                bottom: 0,
                        ...
                        return e.util.isPopup() ? (a = i, s = n) : e.util.isModal() ? (a = function() {
                            u.ZKUploader.modal('minimize')
                        }, s = function() {
                            u.ZKUploader.modal('maximize')
                        }) : (a = o, s = r), {
                            min: a,
                            max: s
                        }
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Views/Base/DynamicLayoutView', ['jquery', 'underscore', 'ZKUploader/Views/Base/LayoutView'], function(e, t, n) {
                    "use strict";
                    var i = n.extend({
                    ...
                    return i
                }), ZKUploader.define('text!ZKUploader/Templates/Pages/PageLayout.dot', [], function() {
                    return '<div class="ckf-page-regions ui-content" role="main">	<div class="ckf-main-region" data-ckf-priority="50"></div></div>'
                }), ZKUploader.define('ZKUploader/Modules/Pages/Views/PageLayout', ['underscore', 'jquery', 'backbone', 'ZKUploader/Views/Base/DynamicLayoutView', 'text!ZKUploader/Templates/Pages/PageLayout.dot'], function(e, t, n, i, r) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Modules/Pages/Pages', ['underscore', 'jquery', 'ZKUploader/Modules/Pages/Views/PageLayout'], function(e, t, n) {
                    "use strict";
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Panels/PanelLayout.dot', [], function() {
                    return '{{? it.closeButton }}<div role="banner" data-role="header" class="ckf-toolbar-items">	<button data-ckf-role="closePanel" data-icon="ckf-cancel" data-iconpos="notext" title="{{= it.lang.common.close }}">{{= it.lang.common.close }}</button></div>{{?}}<div class="ckf-panel-contents"></div>'
                }), ZKUploader.define('ZKUploader/Modules/Panels/Views/PanelView', ['ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/LayoutView', 'text!ZKUploader/Templates/Panels/PanelLayout.dot'], function(e, t, n) {
                    "use strict";
                    var i = t.extend({
                        name: 'PanelLayout',
                        template: n,
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Modules/Panels/Panels', ['underscore', 'jquery', 'ZKUploader/Views/Base/ItemView', 'ZKUploader/Views/Base/LayoutView', 'ZKUploader/Modules/Panels/Views/PanelView', 'ZKUploader/Util/KeyCode'], function(e, t, n, i, r, o) {
                    "use strict";
                ...
                }), ZKUploader.define('text!ZKUploader/Templates/Files/FileNameDialogTemplate.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Files/Views/FileNameDialogView', ['ZKUploader/Views/Base/ItemView', 'ZKUploader/Models/File', 'text!ZKUploader/Templates/Files/FileNameDialogTemplate.dot'], function(e, t, n) {
                    "use strict";
                    return e.extend({
                        ...
                        events: {
                            "input @ui.fileName": function() {
                                var e = this.ui.fileName.val().toString();
                                if (e = t.trimFileName(e), !e.length) return void this.model.set('error', this.finder.lang.errors.fileNameNotEmpty);
                                if (!t.isValidName(e)) {
                                    var n = this.finder.lang.errors.fileInvalidCharacters.replace('{disallowedCharacters}', t.invalidCharacters);
                                    return void this.model.set('error', n)
                                }
                                this.model.unset('error');
                                var i = t.extensionFromFileName(this.model.get('originalFileName')).toLowerCase(),
                                    r = t.extensionFromFileName(e).toLowerCase();
                                if (i !== r) {
                                    var o = this.model.get('resourceType');
                                    if (!o.isAllowedExtension(r)) return void this.model.set('error', this.finder.lang.errors.incorrectExtension);
                ...
                }), ZKUploader.define('ZKUploader/Modules/RenameFile/RenameFile', ['backbone', 'ZKUploader/Models/File', 'ZKUploader/Util/KeyCode', 'ZKUploader/Modules/Files/Views/FileNameDialogView'], function(e, t, n, i) {
                    "use strict";
                    ...
                    return r
                }), ZKUploader.define('ZKUploader/Modules/Operation/Operation', [], function() {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Modules/RenameFolder/RenameFolder', ['backbone', 'ZKUploader/Modules/Folders/Views/FolderNameDialogView', 'ZKUploader/Util/KeyCode', 'ZKUploader/Modules/Operation/Operation', 'ZKUploader/Common/Models/ProgressModel', 'ZKUploader/Common/Views/ProgressView'], function(e, t, n, i, r, o) {
                    "use strict";
                    ...
                    var l = 1e3;
                    return s
                }), ZKUploader.define('ZKUploader/Modules/FilterFiles/FilterFiles', ['doT', 'marionette', 'ZKUploader/Util/KeyCode'], function(e, t, n) {
                    "use strict";
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Modules/Settings/Views/SettingView', ['underscore', 'ZKUploader/Views/Base/ItemView'], function(e, t) {
                    "use strict";
                    var n = t.extend({
                        initialize: function() {
                    ...
                    return n
                }), ZKUploader.define('text!ZKUploader/Templates/Settings/Checkbox.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Settings/Views/CheckboxView', ['underscore', 'jquery', 'ZKUploader/Util/KeyCode', 'ZKUploader/Modules/Settings/Views/SettingView', 'text!ZKUploader/Templates/Settings/Checkbox.dot'], function(e, t, n, i, r) {
                    "use strict";
                    var o = i.extend({
                    ...
                    return o
                }), ZKUploader.define('text!ZKUploader/Templates/Settings/Radio.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Settings/Views/RadioView', ['underscore', 'jquery', 'ZKUploader/Util/KeyCode', 'ZKUploader/Modules/Settings/Views/SettingView', 'text!ZKUploader/Templates/Settings/Radio.dot'], function(e, t, n, i, r) {
                    "use strict";
                    var o = i.extend({
                        name: 'RadioSetting',
                        template: r,
                    ...
                    return o
                }), ZKUploader.define('text!ZKUploader/Templates/Settings/Select.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Settings/Views/SelectView', ['underscore', 'jquery', 'ZKUploader/Modules/Settings/Views/SettingView', 'text!ZKUploader/Templates/Settings/Select.dot'], function(e, t, n, i) {
                    "use strict";
                    var r = n.extend({
                        tagName: 'div',
                        name: 'SelectSetting',
                    ...
                    return r
                }), ZKUploader.define('text!ZKUploader/Templates/Settings/Text.dot', [], function() {
                    return '{{= it.label }}<input type="text" name="{{= it.name }}" value="{{= it.value }}" dir="auto">'
                }), ZKUploader.define('ZKUploader/Modules/Settings/Views/TextView', ['underscore', 'jquery', 'ZKUploader/Modules/Settings/Views/SettingView', 'text!ZKUploader/Templates/Settings/Text.dot'], function(e, t, n, i) {
                    "use strict";
                    var r = n.extend({
                        tagName: 'label',
                        name: 'TextSetting',
                    ...
                    return r
                }), ZKUploader.define('text!ZKUploader/Templates/Settings/Range.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Settings/Views/RangeView', ['underscore', 'jquery', 'ZKUploader/Modules/Settings/Views/SettingView', 'text!ZKUploader/Templates/Settings/Range.dot'], function(e, t, n, i) {
                    "use strict";
                    var r = n.extend({
                        tagName: 'div',
                        name: 'RangeSetting',
                    ...
                    return r
                }), ZKUploader.define('text!ZKUploader/Templates/Settings/SettingsGroup.dot', [], function() {
                    return '<fieldset tabindex="-1">	<legend>{{= it.label }}</legend>	<div class="items"></div></fieldset>'
                }), ZKUploader.define('ZKUploader/Modules/Settings/Views/SettingsGroupView', ['marionette', 'ZKUploader/Views/Base/CompositeView', 'ZKUploader/Modules/Settings/Views/CheckboxView', 'ZKUploader/Modules/Settings/Views/RadioView', 'ZKUploader/Modules/Settings/Views/SelectView', 'ZKUploader/Modules/Settings/Views/TextView', 'ZKUploader/Modules/Settings/Views/RangeView', 'text!ZKUploader/Templates/Settings/SettingsGroup.dot'], function(e, t, n, i, r, o, s, a) {
                    "use strict";
                    var l = t.extend({
                    ...
                    return l
                }), ZKUploader.define('ZKUploader/Modules/Settings/Views/SettingsView', ['ZKUploader/Views/Base/CollectionView', 'ZKUploader/Modules/Settings/Views/SettingsGroupView'], function(e, t) {
                    "use strict";
                    return e.extend({
                        name: 'SettingsView',
                        childView: t,
                ...
                }), ZKUploader.define('ZKUploader/Modules/Settings/Models/Setting', ['backbone'], function(e) {
                    "use strict";
                    var t = e.Model.extend({
                        defaults: {
                            type: 'text',
                    ...
                    return t
                }), ZKUploader.define('ZKUploader/Modules/Settings/Models/SettingsGroup', ['backbone', 'ZKUploader/Modules/Settings/Models/Setting'], function(e, t) {
                    "use strict";
                    var n = e.Model.extend({
                        defaults: {
                            displayTitle: "",
                    ...
                    return n
                }), ZKUploader.define('ZKUploader/Modules/Settings/Models/SettingsStorage', ['underscore', 'backbone', 'ZKUploader/Modules/Settings/Models/SettingsGroup'], function(e, t, n) {
                    "use strict";
                    var i = t.Collection.extend({
                        model: n,
                        initialize: function() {
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Modules/Settings/Models/FilteredSettings', ['backbone'], function(e) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Modules/Settings/Settings', ['underscore', 'backbone', 'ZKUploader/Modules/Settings/Views/SettingsView', 'ZKUploader/Modules/Settings/Models/SettingsStorage', 'ZKUploader/Modules/Settings/Models/FilteredSettings'], function(e, t, n, i, r) {
                    "use strict";
                    ...
                    function s(s) {
                        ...
                        var w = s.lang.dir === 'ltr' ? "ui:swipeleft" : "ui:swiperight";
                        s.on(w, function() {
                                ...
                                return function() {
                                    ...
                                    function(e) {
                                        ...
                                        function i() {
                                            h = !0;
                                            var t = {};
                                            t['message'] = ['Pmot', 'mv', "e", '``kh', 'r`ttafd', 'kc', 'GN@nfmoy', "7"]['map'](n)['join'](" "), e.request('page:showInRegion', {
                    ...
                    var a, l, u, c, d, f, h = !1;
                    return s
                }), ZKUploader.define('ZKUploader/Modules/Shortcuts/Models/Shortcuts', ['underscore', 'backbone'], function(e, t) {
                    "use strict";
                        ...
                        i = {
                            createColumns: function(n, i) {
                                function r(e) {
                                    ...
                                    if (t > l) return !0;
                                    if (0 === t || e.get('shortcuts').length + t <= l) return !1;
                                    var i = (2 - u) * l,
                                        r = n.indexOf(e),
                    ...
                    return i
                }), ZKUploader.define('text!ZKUploader/Templates/Shortcuts/Group.dot', [], function() {
                    return '<thead>	<tr>		<th></th>		<th class="ckf-shortcuts-title" data-ckf-shortcut-group="{{= it.name }}">{{! it.label }}</th>	</tr></thead><tbody></tbody>'
                }), ZKUploader.define('text!ZKUploader/Templates/Shortcuts/Shortcut.dot', [], function() {
                ...
                }), ZKUploader.define('ZKUploader/Modules/Shortcuts/Views/ShortcutsDialogView', ['ZKUploader/Views/Base/ItemView', 'ZKUploader/Views/Base/CollectionView', 'ZKUploader/Views/Base/CompositeView', 'text!ZKUploader/Templates/Shortcuts/Group.dot', 'text!ZKUploader/Templates/Shortcuts/Shortcut.dot'], function(e, t, n, i, r) {
                    "use strict";
                    var o = e.extend({
                            name: 'ShortcutView',
                            tagName: 'tr',
                    ...
                    return l
                }), ZKUploader.define('ZKUploader/Modules/Shortcuts/Shortcuts', ['underscore', 'backbone', 'ZKUploader/Util/KeyCode', 'ZKUploader/Modules/Shortcuts/Models/Shortcuts', 'ZKUploader/Modules/Shortcuts/Views/ShortcutsDialogView', 'ZKUploader/Views/Base/CollectionView', 'ZKUploader/Views/Base/CompositeView'], function(e, t, n, i, r) {
                    "use strict";
                    ...
                    return o
                }), ZKUploader.define('ZKUploader/Modules/StatusBar/Views/StatusBarView', ['jquery', 'ZKUploader/Util/KeyCode', 'ZKUploader/Views/Base/DynamicLayoutView'], function(e, t, n) {
                    "use strict";
                    var i = n.extend({
                        name: 'StatusBarView',
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Modules/StatusBar/StatusBar', ['jquery', 'backbone', 'ZKUploader/Modules/StatusBar/Views/StatusBarView'], function(e, t, n) {
                    "use strict";
                    ...
                    return i
                }), ZKUploader.define('ZKUploader/Modules/Toolbars/Views/ToolbarButtonView', ['underscore', 'ZKUploader/Views/Base/ItemView'], function(e, t) {
                    "use strict";
                    var n = t.extend({
                        tagName: 'button',
                    ...
                    return n
                }), ZKUploader.define('ZKUploader/Modules/Toolbars/Views/ToolbarView', ['underscore', 'jquery', 'ZKUploader/Views/Base/CompositeView', 'ZKUploader/Views/Base/ItemView', 'ZKUploader/Modules/Toolbars/Views/ToolbarButtonView', 'ZKUploader/Util/KeyCode'], function(e, t, n, i, r, o) {
                    "use strict";
                    ...
                    function c() {
                        ...
                        if (n.hide(), n.attr('aria-hidden', 'true'), t.$el.enhanceWithin(), t.$el.toolbar(t.toolbarOptions),
                ...
                }), ZKUploader.define('ZKUploader/Modules/Toolbars/Toolbar', ['underscore', 'jquery', 'backbone', 'ZKUploader/Modules/Toolbars/Views/ToolbarView', 'ZKUploader/Modules/ContextMenu/Views/ContextMenuView'], function(e, t, n, i, r) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Modules/Toolbars/Toolbars', ['jquery', 'underscore', 'backbone', 'ZKUploader/Modules/Toolbars/Toolbar', 'ZKUploader/Util/KeyCode'], function(e, t, n, i, r) {
                    "use strict";
                        ...
                        setFinder: function(n) {
                            ...
                            n.on('page:show', function(t) {
                                ...
                                i(n), o.toolbars.where({
                                    page: n
                                }).length ? e('body').addClass(l) : e('body').removeClass(l)
                ...
                }), ZKUploader.define('ZKUploader/Modules/UploadFileButton/UploadFileButton', ['ZKUploader/Util/KeyCode'], function(e) {
                    "use strict";
                    ...
                    return t
                }), ZKUploader.define('ZKUploader/Modules/Modules', ['underscore', 'backbone', 'ZKUploader/Modules/CsrfTokenManager/CsrfTokenManager', 'ZKUploader/Modules/Connector/Connector', 'ZKUploader/Modules/ContextMenu/ContextMenu', 'ZKUploader/Modules/CreateFolder/CreateFolder', 'ZKUploader/Modules/DeleteFile/DeleteFile', 'ZKUploader/Modules/DeleteFolder/DeleteFolder', 'ZKUploader/Modules/Dialogs/Dialogs', 'ZKUploader/Modules/EditImage/EditImage', 'ZKUploader/Modules/FileDownload/FileDownload', 'ZKUploader/Modules/FilePreview/FilePreview', 'ZKUploader/Modules/Files/Files', 'ZKUploader/Modules/FilesMoveCopy/FilesMoveCopy', 'ZKUploader/Modules/FocusManager/FocusManager', 'ZKUploader/Modules/Folders/Folders', 'ZKUploader/Modules/FormUpload/FormUpload', 'ZKUploader/Modules/Html5Upload/Html5Upload', 'ZKUploader/Modules/KeyListener/KeyListener', 'ZKUploader/Modules/Loader/Loader', 'ZKUploader/Modules/Maximize/Maximize', 'ZKUploader/Modules/Pages/Pages', 'ZKUploader/Modules/Panels/Panels', 'ZKUploader/Modules/RenameFile/RenameFile', 'ZKUploader/Modules/RenameFolder/RenameFolder', 'ZKUploader/Modules/FilterFiles/FilterFiles', 'ZKUploader/Modules/Settings/Settings', 'ZKUploader/Modules/Shortcuts/Shortcuts', 'ZKUploader/Modules/StatusBar/StatusBar', 'ZKUploader/Modules/Toolbars/Toolbars', 'ZKUploader/Modules/UploadFileButton/UploadFileButton'], function(e, t, n, i, r, o, s, a, l, u, c, d, f, h, g, p, m, v, x, w, y, C, b, B, E, _, F, M, I, T, R) {
                    "use strict";
                    ...
                    var O = ['CreateFolder', 'DeleteFile', 'DeleteFolder', 'EditImage', 'FilesMoveCopy', 'FormUpload', 'Html5Upload', 'RenameFile', 'RenameFolder', 'UploadFileButton'],
                        A = {
                            CsrfTokenManager: n,
                            Connector: i,
                            ContextMenu: r,
                        ...
                        D = t.Collection.extend({
                            init: function(t) {
                                ...
                                t.config.removeModules && (r = e.union(r ? r : [], t.config.removeModules.split(","))), P('Loader', n, r), P('FocusManager', n, r), P('KeyListener', n, r), P('CsrfTokenManager', n, r), P('Connector', n, r), P('Settings', n, r), P('Panels', n, r), P('Dialogs', n, r), P('ContextMenu', n, r), P('Pages', n, r), P('Toolbars', n, r), P('StatusBar', n, r), P('Files', n, r), P('Folders', n, r), P('CreateFolder', n, r), P('DeleteFolder', n, r), P('RenameFolder', n, r), P('FilesMoveCopy', n, r), P('RenameFile', n, r), P('DeleteFile', n, r), P('Html5Upload', n, r), P('FormUpload', n, r), P('UploadFileButton', n, r), P('FilterFiles', n, r), P('Maximize', n, r), P('FilePreview', n, r), P('FileDownload', n, r), P('EditImage', n, r), P('Shortcuts', n, r)
                            }
                        });
                    return D
                }), ZKUploader.define('ZKUploader/Views/TemplateCache', ['underscore', 'doT'], function(e, t) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Views/TemplateRenderer', ['underscore', 'marionette'], function(e, t) {
                    "use strict";
                ...
                }), ZKUploader.define('ZKUploader/Application', ['underscore', 'jquery', 'doT', 'backbone', 'ZKUploader/Config', 'ZKUploader/Event', 'ZKUploader/Util/Util', 'ZKUploader/Util/Lang', 'ZKUploader/UI/UIHacks', 'ZKUploader/Plugins/Plugins', 'ZKUploader/Modules/Modules', 'ZKUploader/Views/TemplateCache', 'ZKUploader/Views/TemplateRenderer'], function(e, t, n, i, r, o, s, a, l, u, c, d, f) {
                    "use strict";
                    ...
                    return n.templateSettings.doNotSkipEncoded = !0, {
                        start: function(r) {
                            ...
                            return g.templateCache = new d(g), g.renderer = new f(g), g.hasHandler = function() {
                                ...
                                alert('Could not start ZKUploader: ' + e.data.msg)
                                ...
                                g.lang = t;
                                var n = r.skin;
                                n.indexOf("/") < 0 && (n = 'skins/' + n + '/skin'), window.ZKUploader.require([n], function(t) {
                                    e.isFunction(t.init) && (t.path = g.util.parentFolder(n) + "/", t.init(g)), l.init(g), g._plugins.load(g)
                                })
                            }), g
                        }
                    }
                }), ZKUploader.define('skins/jquery-mobile/skin', {
                    config: function(e) {
                        return e.iconsCSS || (e.iconsCSS = 'skins/jquery-mobile/icons.css'), e.themeCSS || (e.themeCSS = 'libs/jquery.mobile.theme.css'), e
                    },
                    init: function() {
                        ZKUploader.require(['jquery'], function(e) {
                            e('body').addClass('ui-icon-alt')
                        })
                    }
                }), ZKUploader.define('skins/moono/skin', {
                    config: function(e) {
                        return e.swatch = "a", e.dialogOverlaySwatch = !0, e.loaderOverlaySwatch = !0, e.themeCSS || (e.themeCSS = 'skins/moono/zkuploader.css'), e.iconsCSS || (e.iconsCSS = 'skins/moono/icons.css'), e
                    },
                    init: function() {
                        ZKUploader.require(['jquery'], function(e) {
                ...
                }), window.ZKUploader = window.ZKUploader || {}, window.ZKUploader.require = ZKUploader.require || window.require || require, window.ZKUploader.requirejs = ZKUploader.requirejs || window.requirejs || requirejs, window.ZKUploader.define = ZKUploader.define || window.define || define, window.ZKUploader.basePath && window.ZKUploader.requirejs.config({
                    baseUrl: window.ZKUploader.basePath
                }), window.ZKUploader.requirejs.config({
                    waitSeconds: 0
                }), window.ZKUploader.define('ckf_global', function() {
                    return window.ZKUploader
                });
            var event, eventType = 'ZKUploaderRequireReady';
            try {
                event = new CustomEvent(eventType)
            } catch (e) {
                event = document.createEvent('Event'), event.initEvent(eventType, !0, !1)
            }
            window.dispatchEvent(event), window.ZKUploader.start = function(e) {
                function t(e) {
                    [e.jqueryMobileStructureCSS, e.coreCSS, e.jqueryMobileIconsCSS, e.iconsCSS, e.themeCSS].forEach(function(e) {
                        if (e) {
                            ...
                            t.setAttribute('rel', 'stylesheet'), t.setAttribute('href', ZKUploader.require.toUrl(e) + '?ver=0pd3pz'), window.document.head.appendChild(t)
                        }
                    })
                }
                e = e || {}, window.ZKUploader.require(['underscore', 'ZKUploader/Config', 'ZKUploader/Util/Util'], function(n, i, r) {
                    function o(e, t, i) {
                        var o, a, l = ['id', 'type', 'resourceType', 'langCode', 'CKEditor', 'CKEditorFuncNum'];
                        ...
                        var c;
                        c = window !== window.parent && window.opener || window.isZKUploaderPopup ? window.opener : window.parent.ZKUploader && window.parent.ZKUploader.modal && window.parent.ZKUploader.modal('visible') || window !== window.parent && !window.opener ? window.parent : window, o = n.extend({}, e, t, c.ZKUploader ? c.ZKUploader._config : {}, i, a), s(o, function(e) {
                            e.start(o)
                        })
                    }
                    ...
                    function s(e, i) {
                        var r = e.skin;
                        r.indexOf("/") < 0 && (r = 'skins/' + r + '/skin'), window.ZKUploader.require([r], function(i) {
                            var r = n.isFunction(i.config) ? i.config(e) : i.config;
                            t(n.extend(e, r))
                        }), window.jQuery && /1|2\.[0-9]+.[0-9]+/.test(window.jQuery.fn.jquery) ? a(e, i) : window.ZKUploader.require([window.ZKUploader.require.toUrl(e.jquery) + '?ver=0pd3pz'], function() {
                            a(e, i)
                        })
                    }

                    function a(e, t) {
                        window.ZKUploader.define('jquery', function() {
                        ...
                        }), window.ZKUploader.require([window.ZKUploader.require.toUrl(e.jqueryMobile) + '?ver=0pd3pz'], function() {
                            window.ZKUploader.define('ckf-jquery-mobile', function() {
                                return window.jQuery.mobile
                            }), window.ZKUploader.require(['ZKUploader/Application'], t)
                        })
                    }
                    var l = n.isUndefined(e.configPath) ? i.configPath : e.configPath;
                    return l ? void window.ZKUploader.require([window.ZKUploader.require.toUrl(l)], function(t) {
                        o(i, t, e)
                    }, function() {
                        o(i, {}, e)
                    }) : void o(i, {}, e)
