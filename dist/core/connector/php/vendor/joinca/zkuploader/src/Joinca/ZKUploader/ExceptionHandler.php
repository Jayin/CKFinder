...
class ExceptionHandler implements EventSubscriberInterface
{
    ...
    public function onZKUploaderError(GetResponseForExceptionEvent $event)
    {
        ...
        if ($exception instanceof ZKUploaderException) {
    ...
    {
        return array(KernelEvents::EXCEPTION => array('onZKUploaderError', -255));
    }
}
