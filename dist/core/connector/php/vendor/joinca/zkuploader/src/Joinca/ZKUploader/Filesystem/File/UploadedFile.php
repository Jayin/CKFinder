...
class UploadedFile extends File
{
     ...
     */
    public function __construct(UploadedFileBase $uploadedFile, ZKUploader $app)
    {
        ...
        if (!is_writable($this->tempFilePath)) {
            throw new InvalidUploadException('The temporary folder is not writable for ZKUploader');
        }
