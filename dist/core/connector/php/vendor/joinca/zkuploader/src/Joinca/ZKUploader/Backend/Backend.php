...
use Joinca\ZKUploader\Backend\Adapter\AwsS3;
use Joinca\ZKUploader\Backend\Adapter\EmulateRenameDirectoryInterface;
...
class Backend extends Filesystem
{
     ...
     * @param ZKUploader         $app              the ZKUploader app container
     * @param AdapterInterface $adapter          the adapter
     * @param array|null       $filesystemConfig the configuration
     */
    public function __construct(array $backendConfig, ZKUploader $app, AdapterInterface $adapter, $filesystemConfig = null)
    {
        $this->app = $app;
     ...
     * URL will point to the ZKUploader connector Proxy command.
     *
