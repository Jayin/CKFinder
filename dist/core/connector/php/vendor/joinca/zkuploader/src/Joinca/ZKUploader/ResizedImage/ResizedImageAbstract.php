...
namespace Joinca\ZKUploader\ResizedImage;
...
abstract class ResizedImageAbstract
{
    ...
    public function readStream()
    {
        if (null === $this->resizedImageData) {
            throw new ZKUploaderException('The resized image was not loaded from a backend yet. Please use ResizedImage::load() first.');
        }
